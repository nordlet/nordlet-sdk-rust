...
pub enum PostV1SalesInvoicesCreateResponseType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1SalesInvoicesCreateResponseType {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesCreateResponseType {
...
impl fmt::Display for PostV1SalesInvoicesCreateResponseType {
