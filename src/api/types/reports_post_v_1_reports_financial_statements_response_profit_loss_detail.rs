...
pub struct PostV1ReportsFinancialStatementsResponseProfitLossDetail {
...
impl PostV1ReportsFinancialStatementsResponseProfitLossDetail {
    pub fn builder() -> PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder {
        <PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder {
...
impl PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1ReportsFinancialStatementsResponseProfitLossDetail`].
    /// This method will fail if any of the following fields are not set:
    /// - [`sales_revenue`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::sales_revenue)
    /// - [`cost_of_sales`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::cost_of_sales)
    /// - [`gross_profit`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::gross_profit)
    /// - [`selling_expenses`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::selling_expenses)
    /// - [`admin_expenses`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::admin_expenses)
    /// - [`operating_profit`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::operating_profit)
    /// - [`other_activity_result`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::other_activity_result)
    /// - [`financial_activity_result`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::financial_activity_result)
    /// - [`profit_before_tax`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::profit_before_tax)
    /// - [`income_tax`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::income_tax)
    /// - [`net_profit`](PostV1ReportsFinancialStatementsResponseProfitLossDetailBuilder::net_profit)
    pub fn build(
        self,
    ) -> Result<PostV1ReportsFinancialStatementsResponseProfitLossDetail, BuildError> {
        Ok(PostV1ReportsFinancialStatementsResponseProfitLossDetail {
            sales_revenue: self
                .sales_revenue
