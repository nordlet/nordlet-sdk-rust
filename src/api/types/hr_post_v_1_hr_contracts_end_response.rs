...
pub struct PostV1HrContractsEndResponse {
    ...
    pub work_hours_unit: PostV1HrContractsEndResponseWorkHoursUnit,
...
pub struct PostV1HrContractsEndResponseBuilder {
    ...
    work_hours_unit: Option<PostV1HrContractsEndResponseWorkHoursUnit>,
...
impl PostV1HrContractsEndResponseBuilder {
    ...
    pub fn work_hours_unit(mut self, value: PostV1HrContractsEndResponseWorkHoursUnit) -> Self {
    ...
    /// - [`work_hours`](PostV1HrContractsEndResponseBuilder::work_hours)
    /// - [`work_hours_unit`](PostV1HrContractsEndResponseBuilder::work_hours_unit)
