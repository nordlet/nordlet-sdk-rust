...
pub enum PostV1LedgerAccountsUpdateResponseType {
    Asset,
    Liability,
    Equity,
    Income,
...
impl Serialize for PostV1LedgerAccountsUpdateResponseType {
...
impl<'de> Deserialize<'de> for PostV1LedgerAccountsUpdateResponseType {
...
impl fmt::Display for PostV1LedgerAccountsUpdateResponseType {
