...
pub enum PostV1ReferenceVatResolveResponseScheme {
    Domestic,
    IntraEuB2B,
    ReverseCharge,
    OssUnion,
...
impl Serialize for PostV1ReferenceVatResolveResponseScheme {
...
impl<'de> Deserialize<'de> for PostV1ReferenceVatResolveResponseScheme {
...
impl fmt::Display for PostV1ReferenceVatResolveResponseScheme {
