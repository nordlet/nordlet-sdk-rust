...
pub struct PostV1PartnersUpdateRequest {
    #[serde(default)]
    pub id: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub r#type: Option<PostV1PartnersUpdateRequestType>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl PostV1PartnersUpdateRequest {
    pub fn builder() -> PostV1PartnersUpdateRequestBuilder {
        <PostV1PartnersUpdateRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PartnersUpdateRequestBuilder {
    id: Option<String>,
    r#type: Option<PostV1PartnersUpdateRequestType>,
    name: Option<String>,
    code: Option<String>,
...
impl PostV1PartnersUpdateRequestBuilder {
    ...
    pub fn r#type(mut self, value: PostV1PartnersUpdateRequestType) -> Self {
    ...
    pub fn address(mut self, value: PostV1PartnersUpdateRequestAddress) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1PartnersUpdateRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PartnersUpdateRequestBuilder::id)
    pub fn build(self) -> Result<PostV1PartnersUpdateRequest, BuildError> {
        Ok(PostV1PartnersUpdateRequest {
