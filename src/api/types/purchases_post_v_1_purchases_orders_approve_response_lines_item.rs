...
pub struct PostV1PurchasesOrdersApproveResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1PurchasesOrdersApproveResponseLinesItem {
    pub fn builder() -> PostV1PurchasesOrdersApproveResponseLinesItemBuilder {
        <PostV1PurchasesOrdersApproveResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesOrdersApproveResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1PurchasesOrdersApproveResponseLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesOrdersApproveResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::id)
    /// - [`description`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::quantity)
    /// - [`received_qty`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::received_qty)
    /// - [`remaining_qty`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::remaining_qty)
    /// - [`vat_rate_percent`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1PurchasesOrdersApproveResponseLinesItemBuilder::sort_order)
    pub fn build(self) -> Result<PostV1PurchasesOrdersApproveResponseLinesItem, BuildError> {
        Ok(PostV1PurchasesOrdersApproveResponseLinesItem {
