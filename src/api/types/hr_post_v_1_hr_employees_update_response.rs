...
pub struct PostV1HrEmployeesUpdateResponse {
    #[serde(default)]
    pub id: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<PostV1HrEmployeesUpdateResponseAddress>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl PostV1HrEmployeesUpdateResponse {
    pub fn builder() -> PostV1HrEmployeesUpdateResponseBuilder {
        <PostV1HrEmployeesUpdateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1HrEmployeesUpdateResponseBuilder {
    id: Option<String>,
    code: Option<String>,
    ...
    email: Option<String>,
    phone: Option<String>,
    address: Option<PostV1HrEmployeesUpdateResponseAddress>,
    iban: Option<String>,
...
impl PostV1HrEmployeesUpdateResponseBuilder {
    ...
    pub fn address(mut self, value: PostV1HrEmployeesUpdateResponseAddress) -> Self {
    ...
    pub fn status(mut self, value: PostV1HrEmployeesUpdateResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1HrEmployeesUpdateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1HrEmployeesUpdateResponseBuilder::id)
    /// - [`first_name`](PostV1HrEmployeesUpdateResponseBuilder::first_name)
    /// - [`last_name`](PostV1HrEmployeesUpdateResponseBuilder::last_name)
    /// - [`apply_npd`](PostV1HrEmployeesUpdateResponseBuilder::apply_npd)
    /// - [`pension_accumulation`](PostV1HrEmployeesUpdateResponseBuilder::pension_accumulation)
    /// - [`status`](PostV1HrEmployeesUpdateResponseBuilder::status)
    /// - [`created_at`](PostV1HrEmployeesUpdateResponseBuilder::created_at)
    pub fn build(self) -> Result<PostV1HrEmployeesUpdateResponse, BuildError> {
        Ok(PostV1HrEmployeesUpdateResponse {
