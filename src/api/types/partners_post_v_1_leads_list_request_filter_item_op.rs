...
pub enum PostV1LeadsListRequestFilterItemOp {
    Eq,
    Ne,
    Contains,
    Gte,
...
impl Serialize for PostV1LeadsListRequestFilterItemOp {
...
impl<'de> Deserialize<'de> for PostV1LeadsListRequestFilterItemOp {
...
impl fmt::Display for PostV1LeadsListRequestFilterItemOp {
