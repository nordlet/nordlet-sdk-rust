...
pub struct PostV1PartnersGetResponse {
    #[serde(default)]
    pub id: String,
    pub r#type: PostV1PartnersGetResponseType,
    #[serde(default)]
    pub name: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub correspondence_address: Option<PostV1PartnersGetResponseCorrespondenceAddress>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub legal_country_class: Option<PostV1PartnersGetResponseLegalCountryClass>,
...
impl PostV1PartnersGetResponse {
    pub fn builder() -> PostV1PartnersGetResponseBuilder {
        <PostV1PartnersGetResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PartnersGetResponseBuilder {
    id: Option<String>,
    r#type: Option<PostV1PartnersGetResponseType>,
    name: Option<String>,
    code: Option<String>,
    ...
    correspondence_address: Option<PostV1PartnersGetResponseCorrespondenceAddress>,
    notes: Option<String>,
    ...
    legal_country_class: Option<PostV1PartnersGetResponseLegalCountryClass>,
    created_at: Option<String>,
    updated_at: Option<String>,
}

impl PostV1PartnersGetResponseBuilder {
    pub fn id(mut self, value: impl Into<String>) -> Self {
        self.id = Some(value.into());
        self
    }

    pub fn r#type(mut self, value: PostV1PartnersGetResponseType) -> Self {
    ...
    pub fn address(mut self, value: PostV1PartnersGetResponseAddress) -> Self {
    ...
    pub fn correspondence_address(
        mut self,
        value: PostV1PartnersGetResponseCorrespondenceAddress,
    ) -> Self {
    ...
    pub fn legal_country_class(
        mut self,
        value: PostV1PartnersGetResponseLegalCountryClass,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1PartnersGetResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PartnersGetResponseBuilder::id)
    /// - [`r#type`](PostV1PartnersGetResponseBuilder::r#type)
    /// - [`name`](PostV1PartnersGetResponseBuilder::name)
    /// - [`is_customer`](PostV1PartnersGetResponseBuilder::is_customer)
    /// - [`is_supplier`](PostV1PartnersGetResponseBuilder::is_supplier)
    /// - [`auto_debt_reminder`](PostV1PartnersGetResponseBuilder::auto_debt_reminder)
    /// - [`is_employee`](PostV1PartnersGetResponseBuilder::is_employee)
    /// - [`is_group_member`](PostV1PartnersGetResponseBuilder::is_group_member)
    /// - [`is_active`](PostV1PartnersGetResponseBuilder::is_active)
    /// - [`created_at`](PostV1PartnersGetResponseBuilder::created_at)
    /// - [`updated_at`](PostV1PartnersGetResponseBuilder::updated_at)
    pub fn build(self) -> Result<PostV1PartnersGetResponse, BuildError> {
        Ok(PostV1PartnersGetResponse {
