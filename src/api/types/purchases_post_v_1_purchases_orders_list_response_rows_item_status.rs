...
pub enum PostV1PurchasesOrdersListResponseRowsItemStatus {
    Draft,
    Submitted,
    Approved,
    PartiallyReceived,
...
impl Serialize for PostV1PurchasesOrdersListResponseRowsItemStatus {
...
impl<'de> Deserialize<'de> for PostV1PurchasesOrdersListResponseRowsItemStatus {
...
impl fmt::Display for PostV1PurchasesOrdersListResponseRowsItemStatus {
