...
pub enum PostV1SalesInvoicesCreateRequestType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1SalesInvoicesCreateRequestType {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesCreateRequestType {
...
impl fmt::Display for PostV1SalesInvoicesCreateRequestType {
