...
pub struct PostV1AssetsAssetsCreateResponse {
    #[serde(default)]
    pub id: String,
...
impl PostV1AssetsAssetsCreateResponse {
    pub fn builder() -> PostV1AssetsAssetsCreateResponseBuilder {
        <PostV1AssetsAssetsCreateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1AssetsAssetsCreateResponseBuilder {
    id: Option<String>,
...
impl PostV1AssetsAssetsCreateResponseBuilder {
    ...
    pub fn status(mut self, value: PostV1AssetsAssetsCreateResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1AssetsAssetsCreateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1AssetsAssetsCreateResponseBuilder::id)
    /// - [`group_id`](PostV1AssetsAssetsCreateResponseBuilder::group_id)
    /// - [`code`](PostV1AssetsAssetsCreateResponseBuilder::code)
    /// - [`name`](PostV1AssetsAssetsCreateResponseBuilder::name)
    /// - [`acquisition_date`](PostV1AssetsAssetsCreateResponseBuilder::acquisition_date)
    /// - [`depreciation_start_date`](PostV1AssetsAssetsCreateResponseBuilder::depreciation_start_date)
    /// - [`acquisition_cost`](PostV1AssetsAssetsCreateResponseBuilder::acquisition_cost)
    /// - [`salvage_value`](PostV1AssetsAssetsCreateResponseBuilder::salvage_value)
    /// - [`useful_life_months`](PostV1AssetsAssetsCreateResponseBuilder::useful_life_months)
    /// - [`total_cost`](PostV1AssetsAssetsCreateResponseBuilder::total_cost)
    /// - [`accumulated_depreciation`](PostV1AssetsAssetsCreateResponseBuilder::accumulated_depreciation)
    /// - [`net_book_value`](PostV1AssetsAssetsCreateResponseBuilder::net_book_value)
