...
pub enum PostV1HrEmployeesRecordsUpdateResponseType {
    Education,
    Qualification,
    Certificate,
    Training,
...
impl Serialize for PostV1HrEmployeesRecordsUpdateResponseType {
...
impl<'de> Deserialize<'de> for PostV1HrEmployeesRecordsUpdateResponseType {
...
impl fmt::Display for PostV1HrEmployeesRecordsUpdateResponseType {
