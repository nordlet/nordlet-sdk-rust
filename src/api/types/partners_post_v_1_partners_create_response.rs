...
pub struct PostV1PartnersCreateResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub correspondence_address: Option<PostV1PartnersCreateResponseCorrespondenceAddress>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub legal_country_class: Option<PostV1PartnersCreateResponseLegalCountryClass>,
...
pub struct PostV1PartnersCreateResponseBuilder {
    ...
    correspondence_address: Option<PostV1PartnersCreateResponseCorrespondenceAddress>,
    notes: Option<String>,
    ...
    legal_country_class: Option<PostV1PartnersCreateResponseLegalCountryClass>,
...
impl PostV1PartnersCreateResponseBuilder {
    ...
    pub fn correspondence_address(
        mut self,
        value: PostV1PartnersCreateResponseCorrespondenceAddress,
    ) -> Self {
    ...
    pub fn legal_country_class(
        mut self,
        value: PostV1PartnersCreateResponseLegalCountryClass,
    ) -> Self {
    ...
    /// - [`auto_debt_reminder`](PostV1PartnersCreateResponseBuilder::auto_debt_reminder)
    /// - [`is_employee`](PostV1PartnersCreateResponseBuilder::is_employee)
    /// - [`is_group_member`](PostV1PartnersCreateResponseBuilder::is_group_member)
    /// - [`is_active`](PostV1PartnersCreateResponseBuilder::is_active)
