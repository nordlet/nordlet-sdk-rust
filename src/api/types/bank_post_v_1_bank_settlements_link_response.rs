...
pub struct PostV1BankSettlementsLinkResponse {
    #[serde(default)]
    pub id: String,
    ...
    pub status: PostV1BankSettlementsLinkResponseStatus,
...
impl PostV1BankSettlementsLinkResponse {
    pub fn builder() -> PostV1BankSettlementsLinkResponseBuilder {
        <PostV1BankSettlementsLinkResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1BankSettlementsLinkResponseBuilder {
    id: Option<String>,
    ...
    status: Option<PostV1BankSettlementsLinkResponseStatus>,
...
impl PostV1BankSettlementsLinkResponseBuilder {
    ...
    pub fn status(mut self, value: PostV1BankSettlementsLinkResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1BankSettlementsLinkResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1BankSettlementsLinkResponseBuilder::id)
    /// - [`bank_account_id`](PostV1BankSettlementsLinkResponseBuilder::bank_account_id)
    /// - [`provider`](PostV1BankSettlementsLinkResponseBuilder::provider)
    /// - [`payout_id`](PostV1BankSettlementsLinkResponseBuilder::payout_id)
    /// - [`currency`](PostV1BankSettlementsLinkResponseBuilder::currency)
    /// - [`gross_total`](PostV1BankSettlementsLinkResponseBuilder::gross_total)
    /// - [`fee_total`](PostV1BankSettlementsLinkResponseBuilder::fee_total)
    /// - [`net_total`](PostV1BankSettlementsLinkResponseBuilder::net_total)
    /// - [`status`](PostV1BankSettlementsLinkResponseBuilder::status)
    /// - [`line_count`](PostV1BankSettlementsLinkResponseBuilder::line_count)
    /// - [`matched_count`](PostV1BankSettlementsLinkResponseBuilder::matched_count)
    /// - [`unmatched_count`](PostV1BankSettlementsLinkResponseBuilder::unmatched_count)
    /// - [`created_at`](PostV1BankSettlementsLinkResponseBuilder::created_at)
    /// - [`updated_at`](PostV1BankSettlementsLinkResponseBuilder::updated_at)
    pub fn build(self) -> Result<PostV1BankSettlementsLinkResponse, BuildError> {
        Ok(PostV1BankSettlementsLinkResponse {
