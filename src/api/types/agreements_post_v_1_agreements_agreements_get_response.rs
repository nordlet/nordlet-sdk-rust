...
pub struct PostV1AgreementsAgreementsGetResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_period: Option<PostV1AgreementsAgreementsGetResponseBillingPeriod>,
    #[serde(default)]
    pub currency: String,
...
pub struct PostV1AgreementsAgreementsGetResponseBuilder {
    ...
    value: Option<String>,
    billing_period: Option<PostV1AgreementsAgreementsGetResponseBillingPeriod>,
...
impl PostV1AgreementsAgreementsGetResponseBuilder {
    ...
    pub fn billing_period(
        mut self,
        value: PostV1AgreementsAgreementsGetResponseBillingPeriod,
    ) -> Self {
