...
pub struct PostV1FleetVehiclesGetResponse {
    #[serde(default)]
    pub id: String,
...
impl PostV1FleetVehiclesGetResponse {
    pub fn builder() -> PostV1FleetVehiclesGetResponseBuilder {
        <PostV1FleetVehiclesGetResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1FleetVehiclesGetResponseBuilder {
    id: Option<String>,
...
impl PostV1FleetVehiclesGetResponseBuilder {
    ...
    pub fn status(mut self, value: PostV1FleetVehiclesGetResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1FleetVehiclesGetResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1FleetVehiclesGetResponseBuilder::id)
    /// - [`plate_number`](PostV1FleetVehiclesGetResponseBuilder::plate_number)
    /// - [`make`](PostV1FleetVehiclesGetResponseBuilder::make)
    /// - [`model`](PostV1FleetVehiclesGetResponseBuilder::model)
    /// - [`market_value`](PostV1FleetVehiclesGetResponseBuilder::market_value)
    /// - [`status`](PostV1FleetVehiclesGetResponseBuilder::status)
    /// - [`created_at`](PostV1FleetVehiclesGetResponseBuilder::created_at)
    pub fn build(self) -> Result<PostV1FleetVehiclesGetResponse, BuildError> {
        Ok(PostV1FleetVehiclesGetResponse {
