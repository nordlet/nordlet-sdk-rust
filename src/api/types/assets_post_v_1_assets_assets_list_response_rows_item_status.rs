...
pub enum PostV1AssetsAssetsListResponseRowsItemStatus {
    Active,
    FullyDepreciated,
    Disposed,
...
impl Serialize for PostV1AssetsAssetsListResponseRowsItemStatus {
...
impl<'de> Deserialize<'de> for PostV1AssetsAssetsListResponseRowsItemStatus {
...
impl fmt::Display for PostV1AssetsAssetsListResponseRowsItemStatus {
