...
pub enum PostV1HrTimesheetsGetResponseDaysItemType {
    Work,
    BusinessTrip,
    Vacation,
    Sick,
...
impl Serialize for PostV1HrTimesheetsGetResponseDaysItemType {
...
impl<'de> Deserialize<'de> for PostV1HrTimesheetsGetResponseDaysItemType {
...
impl fmt::Display for PostV1HrTimesheetsGetResponseDaysItemType {
