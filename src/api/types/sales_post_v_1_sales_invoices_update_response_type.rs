...
pub enum PostV1SalesInvoicesUpdateResponseType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1SalesInvoicesUpdateResponseType {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesUpdateResponseType {
...
impl fmt::Display for PostV1SalesInvoicesUpdateResponseType {
