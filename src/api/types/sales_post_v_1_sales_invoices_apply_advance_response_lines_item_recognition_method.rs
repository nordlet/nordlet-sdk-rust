...
pub enum PostV1SalesInvoicesApplyAdvanceResponseLinesItemRecognitionMethod {
    PointInTime,
    Ratable,
    Milestone,
    PercentComplete,
...
impl Serialize for PostV1SalesInvoicesApplyAdvanceResponseLinesItemRecognitionMethod {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesApplyAdvanceResponseLinesItemRecognitionMethod {
...
impl fmt::Display for PostV1SalesInvoicesApplyAdvanceResponseLinesItemRecognitionMethod {
