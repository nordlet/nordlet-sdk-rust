...
pub struct PostV1BankTransactionsRecordResponse {
    #[serde(default)]
    pub id: String,
    ...
    pub status: PostV1BankTransactionsRecordResponseStatus,
...
impl PostV1BankTransactionsRecordResponse {
    pub fn builder() -> PostV1BankTransactionsRecordResponseBuilder {
        <PostV1BankTransactionsRecordResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1BankTransactionsRecordResponseBuilder {
    id: Option<String>,
    ...
    status: Option<PostV1BankTransactionsRecordResponseStatus>,
...
impl PostV1BankTransactionsRecordResponseBuilder {
    ...
    pub fn status(mut self, value: PostV1BankTransactionsRecordResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1BankTransactionsRecordResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1BankTransactionsRecordResponseBuilder::id)
    /// - [`bank_account_id`](PostV1BankTransactionsRecordResponseBuilder::bank_account_id)
    /// - [`date`](PostV1BankTransactionsRecordResponseBuilder::date)
    /// - [`amount`](PostV1BankTransactionsRecordResponseBuilder::amount)
    /// - [`currency`](PostV1BankTransactionsRecordResponseBuilder::currency)
    /// - [`status`](PostV1BankTransactionsRecordResponseBuilder::status)
    /// - [`created_at`](PostV1BankTransactionsRecordResponseBuilder::created_at)
    pub fn build(self) -> Result<PostV1BankTransactionsRecordResponse, BuildError> {
        Ok(PostV1BankTransactionsRecordResponse {
