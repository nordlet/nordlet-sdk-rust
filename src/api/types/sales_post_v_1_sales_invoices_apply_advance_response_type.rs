...
pub enum PostV1SalesInvoicesApplyAdvanceResponseType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1SalesInvoicesApplyAdvanceResponseType {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesApplyAdvanceResponseType {
...
impl fmt::Display for PostV1SalesInvoicesApplyAdvanceResponseType {
