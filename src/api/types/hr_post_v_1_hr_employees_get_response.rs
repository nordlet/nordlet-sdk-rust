...
pub struct PostV1HrEmployeesGetResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<PostV1HrEmployeesGetResponseAddress>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Vec<PostV1HrEmployeesGetResponseAttributesItem>>,
    #[serde(rename = "createdAt")]
    #[serde(default)]
    pub created_at: String,
}

impl PostV1HrEmployeesGetResponse {
    pub fn builder() -> PostV1HrEmployeesGetResponseBuilder {
        <PostV1HrEmployeesGetResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1HrEmployeesGetResponseBuilder {
    id: Option<String>,
    code: Option<String>,
    ...
    email: Option<String>,
    phone: Option<String>,
    address: Option<PostV1HrEmployeesGetResponseAddress>,
    iban: Option<String>,
...
impl PostV1HrEmployeesGetResponseBuilder {
    ...
    pub fn address(mut self, value: PostV1HrEmployeesGetResponseAddress) -> Self {
    ...
    pub fn status(mut self, value: PostV1HrEmployeesGetResponseStatus) -> Self {
    ...
    pub fn attributes(mut self, value: Vec<PostV1HrEmployeesGetResponseAttributesItem>) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1HrEmployeesGetResponse`].
    ...
    pub fn build(self) -> Result<PostV1HrEmployeesGetResponse, BuildError> {
        Ok(PostV1HrEmployeesGetResponse {
