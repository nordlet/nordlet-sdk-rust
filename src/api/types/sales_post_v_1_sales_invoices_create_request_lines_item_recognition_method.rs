...
pub enum PostV1SalesInvoicesCreateRequestLinesItemRecognitionMethod {
    PointInTime,
    Ratable,
    Milestone,
    PercentComplete,
...
impl Serialize for PostV1SalesInvoicesCreateRequestLinesItemRecognitionMethod {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesCreateRequestLinesItemRecognitionMethod {
...
impl fmt::Display for PostV1SalesInvoicesCreateRequestLinesItemRecognitionMethod {
