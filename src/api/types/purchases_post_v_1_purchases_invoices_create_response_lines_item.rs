...
pub struct PostV1PurchasesInvoicesCreateResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1PurchasesInvoicesCreateResponseLinesItem {
    pub fn builder() -> PostV1PurchasesInvoicesCreateResponseLinesItemBuilder {
        <PostV1PurchasesInvoicesCreateResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesInvoicesCreateResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1PurchasesInvoicesCreateResponseLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesInvoicesCreateResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PurchasesInvoicesCreateResponseLinesItemBuilder::id)
    /// - [`description`](PostV1PurchasesInvoicesCreateResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1PurchasesInvoicesCreateResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1PurchasesInvoicesCreateResponseLinesItemBuilder::quantity)
    /// - [`vat_rate_percent`](PostV1PurchasesInvoicesCreateResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1PurchasesInvoicesCreateResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1PurchasesInvoicesCreateResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1PurchasesInvoicesCreateResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1PurchasesInvoicesCreateResponseLinesItemBuilder::sort_order)
    pub fn build(self) -> Result<PostV1PurchasesInvoicesCreateResponseLinesItem, BuildError> {
        Ok(PostV1PurchasesInvoicesCreateResponseLinesItem {
