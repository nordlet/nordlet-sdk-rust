...
pub struct PostV1PurchasesOrdersGetResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1PurchasesOrdersGetResponseLinesItem {
    pub fn builder() -> PostV1PurchasesOrdersGetResponseLinesItemBuilder {
        <PostV1PurchasesOrdersGetResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesOrdersGetResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1PurchasesOrdersGetResponseLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesOrdersGetResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::id)
    /// - [`description`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::quantity)
    /// - [`received_qty`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::received_qty)
    /// - [`remaining_qty`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::remaining_qty)
    /// - [`vat_rate_percent`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1PurchasesOrdersGetResponseLinesItemBuilder::sort_order)
    pub fn build(self) -> Result<PostV1PurchasesOrdersGetResponseLinesItem, BuildError> {
        Ok(PostV1PurchasesOrdersGetResponseLinesItem {
