...
pub struct PostV1SalesActsCreateResponse {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "partnerId")]
    #[serde(default)]
    pub partner_id: String,
    pub r#type: PostV1SalesActsCreateResponseType,
    pub status: PostV1SalesActsCreateResponseStatus,
    #[serde(default)]
    pub series: String,
    ...
    #[serde(default)]
    pub lines: Vec<PostV1SalesActsCreateResponseLinesItem>,
}

impl PostV1SalesActsCreateResponse {
    pub fn builder() -> PostV1SalesActsCreateResponseBuilder {
        <PostV1SalesActsCreateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesActsCreateResponseBuilder {
    id: Option<String>,
    partner_id: Option<String>,
    r#type: Option<PostV1SalesActsCreateResponseType>,
    status: Option<PostV1SalesActsCreateResponseStatus>,
    ...
    lines: Option<Vec<PostV1SalesActsCreateResponseLinesItem>>,
}

impl PostV1SalesActsCreateResponseBuilder {
    ...
    pub fn r#type(mut self, value: PostV1SalesActsCreateResponseType) -> Self {
        self.r#type = Some(value);
        self
    }

    pub fn status(mut self, value: PostV1SalesActsCreateResponseStatus) -> Self {
    ...
    pub fn lines(mut self, value: Vec<PostV1SalesActsCreateResponseLinesItem>) -> Self {
        self.lines = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1SalesActsCreateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1SalesActsCreateResponseBuilder::id)
    /// - [`partner_id`](PostV1SalesActsCreateResponseBuilder::partner_id)
    /// - [`r#type`](PostV1SalesActsCreateResponseBuilder::r#type)
    /// - [`status`](PostV1SalesActsCreateResponseBuilder::status)
    /// - [`series`](PostV1SalesActsCreateResponseBuilder::series)
    /// - [`document_date`](PostV1SalesActsCreateResponseBuilder::document_date)
    /// - [`created_at`](PostV1SalesActsCreateResponseBuilder::created_at)
    /// - [`updated_at`](PostV1SalesActsCreateResponseBuilder::updated_at)
    /// - [`lines`](PostV1SalesActsCreateResponseBuilder::lines)
    pub fn build(self) -> Result<PostV1SalesActsCreateResponse, BuildError> {
        Ok(PostV1SalesActsCreateResponse {
