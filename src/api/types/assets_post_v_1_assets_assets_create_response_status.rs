...
pub enum PostV1AssetsAssetsCreateResponseStatus {
    Active,
    FullyDepreciated,
    Disposed,
...
impl Serialize for PostV1AssetsAssetsCreateResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1AssetsAssetsCreateResponseStatus {
...
impl fmt::Display for PostV1AssetsAssetsCreateResponseStatus {
