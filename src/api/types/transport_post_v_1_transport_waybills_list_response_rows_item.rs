...
pub struct PostV1TransportWaybillsListResponseRowsItem {
    #[serde(default)]
    pub id: String,
    pub status: PostV1TransportWaybillsListResponseRowsItemStatus,
    #[serde(default)]
    pub series: String,
...
impl PostV1TransportWaybillsListResponseRowsItem {
    pub fn builder() -> PostV1TransportWaybillsListResponseRowsItemBuilder {
        <PostV1TransportWaybillsListResponseRowsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1TransportWaybillsListResponseRowsItemBuilder {
    id: Option<String>,
    status: Option<PostV1TransportWaybillsListResponseRowsItemStatus>,
...
impl PostV1TransportWaybillsListResponseRowsItemBuilder {
    pub fn id(mut self, value: impl Into<String>) -> Self {
        self.id = Some(value.into());
        self
    }

    pub fn status(mut self, value: PostV1TransportWaybillsListResponseRowsItemStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1TransportWaybillsListResponseRowsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1TransportWaybillsListResponseRowsItemBuilder::id)
    /// - [`status`](PostV1TransportWaybillsListResponseRowsItemBuilder::status)
    /// - [`series`](PostV1TransportWaybillsListResponseRowsItemBuilder::series)
    /// - [`document_date`](PostV1TransportWaybillsListResponseRowsItemBuilder::document_date)
    /// - [`dispatch_at`](PostV1TransportWaybillsListResponseRowsItemBuilder::dispatch_at)
    /// - [`consignee_partner_id`](PostV1TransportWaybillsListResponseRowsItemBuilder::consignee_partner_id)
    /// - [`load_address`](PostV1TransportWaybillsListResponseRowsItemBuilder::load_address)
    /// - [`unload_address`](PostV1TransportWaybillsListResponseRowsItemBuilder::unload_address)
    /// - [`created_at`](PostV1TransportWaybillsListResponseRowsItemBuilder::created_at)
    /// - [`updated_at`](PostV1TransportWaybillsListResponseRowsItemBuilder::updated_at)
    pub fn build(self) -> Result<PostV1TransportWaybillsListResponseRowsItem, BuildError> {
        Ok(PostV1TransportWaybillsListResponseRowsItem {
