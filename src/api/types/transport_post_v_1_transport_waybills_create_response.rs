...
pub struct PostV1TransportWaybillsCreateResponse {
    #[serde(default)]
    pub id: String,
    pub status: PostV1TransportWaybillsCreateResponseStatus,
    #[serde(default)]
    pub series: String,
    ...
    #[serde(default)]
    pub lines: Vec<PostV1TransportWaybillsCreateResponseLinesItem>,
}

impl PostV1TransportWaybillsCreateResponse {
    pub fn builder() -> PostV1TransportWaybillsCreateResponseBuilder {
        <PostV1TransportWaybillsCreateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1TransportWaybillsCreateResponseBuilder {
    id: Option<String>,
    status: Option<PostV1TransportWaybillsCreateResponseStatus>,
    ...
    lines: Option<Vec<PostV1TransportWaybillsCreateResponseLinesItem>>,
}

impl PostV1TransportWaybillsCreateResponseBuilder {
    pub fn id(mut self, value: impl Into<String>) -> Self {
        self.id = Some(value.into());
        self
    }

    pub fn status(mut self, value: PostV1TransportWaybillsCreateResponseStatus) -> Self {
    ...
    pub fn lines(mut self, value: Vec<PostV1TransportWaybillsCreateResponseLinesItem>) -> Self {
        self.lines = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1TransportWaybillsCreateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1TransportWaybillsCreateResponseBuilder::id)
    /// - [`status`](PostV1TransportWaybillsCreateResponseBuilder::status)
    /// - [`series`](PostV1TransportWaybillsCreateResponseBuilder::series)
    /// - [`document_date`](PostV1TransportWaybillsCreateResponseBuilder::document_date)
    /// - [`dispatch_at`](PostV1TransportWaybillsCreateResponseBuilder::dispatch_at)
    /// - [`consignee_partner_id`](PostV1TransportWaybillsCreateResponseBuilder::consignee_partner_id)
    /// - [`load_address`](PostV1TransportWaybillsCreateResponseBuilder::load_address)
    /// - [`unload_address`](PostV1TransportWaybillsCreateResponseBuilder::unload_address)
    /// - [`created_at`](PostV1TransportWaybillsCreateResponseBuilder::created_at)
    /// - [`updated_at`](PostV1TransportWaybillsCreateResponseBuilder::updated_at)
    /// - [`lines`](PostV1TransportWaybillsCreateResponseBuilder::lines)
    pub fn build(self) -> Result<PostV1TransportWaybillsCreateResponse, BuildError> {
        Ok(PostV1TransportWaybillsCreateResponse {
