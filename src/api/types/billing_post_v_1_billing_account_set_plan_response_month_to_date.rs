...
pub struct PostV1BillingAccountSetPlanResponseMonthToDate {
    #[serde(default)]
    pub from: String,
    #[serde(default)]
    pub to: String,
...
impl PostV1BillingAccountSetPlanResponseMonthToDate {
    pub fn builder() -> PostV1BillingAccountSetPlanResponseMonthToDateBuilder {
        <PostV1BillingAccountSetPlanResponseMonthToDateBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1BillingAccountSetPlanResponseMonthToDateBuilder {
    from: Option<String>,
    to: Option<String>,
...
impl PostV1BillingAccountSetPlanResponseMonthToDateBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1BillingAccountSetPlanResponseMonthToDate`].
    /// This method will fail if any of the following fields are not set:
    /// - [`from`](PostV1BillingAccountSetPlanResponseMonthToDateBuilder::from)
    /// - [`to`](PostV1BillingAccountSetPlanResponseMonthToDateBuilder::to)
    /// - [`api_requests`](PostV1BillingAccountSetPlanResponseMonthToDateBuilder::api_requests)
    /// - [`ocr_pages`](PostV1BillingAccountSetPlanResponseMonthToDateBuilder::ocr_pages)
    /// - [`file_bytes`](PostV1BillingAccountSetPlanResponseMonthToDateBuilder::file_bytes)
    /// - [`database_bytes`](PostV1BillingAccountSetPlanResponseMonthToDateBuilder::database_bytes)
    /// - [`archived_companies`](PostV1BillingAccountSetPlanResponseMonthToDateBuilder::archived_companies)
    /// - [`estimated_today_cents`](PostV1BillingAccountSetPlanResponseMonthToDateBuilder::estimated_today_cents)
    pub fn build(self) -> Result<PostV1BillingAccountSetPlanResponseMonthToDate, BuildError> {
        Ok(PostV1BillingAccountSetPlanResponseMonthToDate {
