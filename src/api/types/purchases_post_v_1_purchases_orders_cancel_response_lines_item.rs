...
pub struct PostV1PurchasesOrdersCancelResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1PurchasesOrdersCancelResponseLinesItem {
    pub fn builder() -> PostV1PurchasesOrdersCancelResponseLinesItemBuilder {
        <PostV1PurchasesOrdersCancelResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesOrdersCancelResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1PurchasesOrdersCancelResponseLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesOrdersCancelResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::id)
    /// - [`description`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::quantity)
    /// - [`received_qty`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::received_qty)
    /// - [`remaining_qty`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::remaining_qty)
    /// - [`vat_rate_percent`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1PurchasesOrdersCancelResponseLinesItemBuilder::sort_order)
    pub fn build(self) -> Result<PostV1PurchasesOrdersCancelResponseLinesItem, BuildError> {
        Ok(PostV1PurchasesOrdersCancelResponseLinesItem {
