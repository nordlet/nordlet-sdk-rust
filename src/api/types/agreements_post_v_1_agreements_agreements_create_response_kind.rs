...
pub enum PostV1AgreementsAgreementsCreateResponseKind {
    Customer,
    Supplier,
    Employment,
    Bank,
...
impl Serialize for PostV1AgreementsAgreementsCreateResponseKind {
...
impl<'de> Deserialize<'de> for PostV1AgreementsAgreementsCreateResponseKind {
...
impl fmt::Display for PostV1AgreementsAgreementsCreateResponseKind {
