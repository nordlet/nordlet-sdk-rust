...
pub enum PostV1SalesInvoicesUpdateRequestVatScheme {
    Domestic,
    IntraEuB2B,
    ReverseCharge,
    OssUnion,
...
impl Serialize for PostV1SalesInvoicesUpdateRequestVatScheme {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesUpdateRequestVatScheme {
...
impl fmt::Display for PostV1SalesInvoicesUpdateRequestVatScheme {
