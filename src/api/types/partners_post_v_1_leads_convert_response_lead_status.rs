...
pub enum PostV1LeadsConvertResponseLeadStatus {
    New,
    Contacted,
    Qualified,
    Lost,
...
impl Serialize for PostV1LeadsConvertResponseLeadStatus {
...
impl<'de> Deserialize<'de> for PostV1LeadsConvertResponseLeadStatus {
...
impl fmt::Display for PostV1LeadsConvertResponseLeadStatus {
