...
pub struct PostV1TransportWaybillsCancelResponse {
    #[serde(default)]
    pub id: String,
    pub status: PostV1TransportWaybillsCancelResponseStatus,
    #[serde(default)]
    pub series: String,
...
impl PostV1TransportWaybillsCancelResponse {
    pub fn builder() -> PostV1TransportWaybillsCancelResponseBuilder {
        <PostV1TransportWaybillsCancelResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1TransportWaybillsCancelResponseBuilder {
    id: Option<String>,
    status: Option<PostV1TransportWaybillsCancelResponseStatus>,
...
impl PostV1TransportWaybillsCancelResponseBuilder {
    pub fn id(mut self, value: impl Into<String>) -> Self {
        self.id = Some(value.into());
        self
    }

    pub fn status(mut self, value: PostV1TransportWaybillsCancelResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1TransportWaybillsCancelResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1TransportWaybillsCancelResponseBuilder::id)
    /// - [`status`](PostV1TransportWaybillsCancelResponseBuilder::status)
    /// - [`series`](PostV1TransportWaybillsCancelResponseBuilder::series)
    /// - [`document_date`](PostV1TransportWaybillsCancelResponseBuilder::document_date)
    /// - [`dispatch_at`](PostV1TransportWaybillsCancelResponseBuilder::dispatch_at)
    /// - [`consignee_partner_id`](PostV1TransportWaybillsCancelResponseBuilder::consignee_partner_id)
    /// - [`load_address`](PostV1TransportWaybillsCancelResponseBuilder::load_address)
    /// - [`unload_address`](PostV1TransportWaybillsCancelResponseBuilder::unload_address)
    /// - [`created_at`](PostV1TransportWaybillsCancelResponseBuilder::created_at)
    /// - [`updated_at`](PostV1TransportWaybillsCancelResponseBuilder::updated_at)
    pub fn build(self) -> Result<PostV1TransportWaybillsCancelResponse, BuildError> {
        Ok(PostV1TransportWaybillsCancelResponse {
