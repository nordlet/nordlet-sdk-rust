...
pub enum PostV1OperationTypesUpdateRequestInvoiceType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1OperationTypesUpdateRequestInvoiceType {
...
impl<'de> Deserialize<'de> for PostV1OperationTypesUpdateRequestInvoiceType {
...
impl fmt::Display for PostV1OperationTypesUpdateRequestInvoiceType {
