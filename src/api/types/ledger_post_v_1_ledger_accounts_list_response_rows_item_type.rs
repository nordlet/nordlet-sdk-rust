...
pub enum PostV1LedgerAccountsListResponseRowsItemType {
    Asset,
    Liability,
    Equity,
    Income,
...
impl Serialize for PostV1LedgerAccountsListResponseRowsItemType {
...
impl<'de> Deserialize<'de> for PostV1LedgerAccountsListResponseRowsItemType {
...
impl fmt::Display for PostV1LedgerAccountsListResponseRowsItemType {
