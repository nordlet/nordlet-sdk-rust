...
pub enum PostV1SalesRecognitionSchedulesListResponseRowsItemMethod {
    PointInTime,
    Ratable,
    Milestone,
    PercentComplete,
...
impl Serialize for PostV1SalesRecognitionSchedulesListResponseRowsItemMethod {
...
impl<'de> Deserialize<'de> for PostV1SalesRecognitionSchedulesListResponseRowsItemMethod {
...
impl fmt::Display for PostV1SalesRecognitionSchedulesListResponseRowsItemMethod {
