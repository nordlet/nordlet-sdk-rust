...
pub struct PostV1LedgerOwnersCreateResponse {
    #[serde(default)]
    pub id: String,
    #[serde(default)]
    pub name: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<PostV1LedgerOwnersCreateResponseAddress>,
    #[serde(rename = "createdAt")]
    #[serde(default)]
    pub created_at: String,
}

impl PostV1LedgerOwnersCreateResponse {
    pub fn builder() -> PostV1LedgerOwnersCreateResponseBuilder {
        <PostV1LedgerOwnersCreateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1LedgerOwnersCreateResponseBuilder {
    id: Option<String>,
    name: Option<String>,
    code: Option<String>,
    ...
    address: Option<PostV1LedgerOwnersCreateResponseAddress>,
    created_at: Option<String>,
}

impl PostV1LedgerOwnersCreateResponseBuilder {
    ...
    pub fn address(mut self, value: PostV1LedgerOwnersCreateResponseAddress) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1LedgerOwnersCreateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1LedgerOwnersCreateResponseBuilder::id)
    /// - [`name`](PostV1LedgerOwnersCreateResponseBuilder::name)
    /// - [`equity_account_code`](PostV1LedgerOwnersCreateResponseBuilder::equity_account_code)
    /// - [`created_at`](PostV1LedgerOwnersCreateResponseBuilder::created_at)
    pub fn build(self) -> Result<PostV1LedgerOwnersCreateResponse, BuildError> {
        Ok(PostV1LedgerOwnersCreateResponse {
