...
pub enum PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod {
    PointInTime,
    Ratable,
    Milestone,
    PercentComplete,
...
impl Serialize for PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod {
...
impl fmt::Display for PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod {
