...
pub struct PostV1HrEmployeesCreateResponse {
    #[serde(default)]
    pub id: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<PostV1HrEmployeesCreateResponseAddress>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub status: PostV1HrEmployeesCreateResponseStatus,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub notes: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Vec<PostV1HrEmployeesCreateResponseAttributesItem>>,
    #[serde(rename = "createdAt")]
    #[serde(default)]
    pub created_at: String,
}

impl PostV1HrEmployeesCreateResponse {
    pub fn builder() -> PostV1HrEmployeesCreateResponseBuilder {
        <PostV1HrEmployeesCreateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1HrEmployeesCreateResponseBuilder {
    id: Option<String>,
    code: Option<String>,
    ...
    email: Option<String>,
    phone: Option<String>,
    address: Option<PostV1HrEmployeesCreateResponseAddress>,
    iban: Option<String>,
    ...
    status: Option<PostV1HrEmployeesCreateResponseStatus>,
    notes: Option<String>,
    attributes: Option<Vec<PostV1HrEmployeesCreateResponseAttributesItem>>,
    created_at: Option<String>,
}

impl PostV1HrEmployeesCreateResponseBuilder {
    ...
    pub fn address(mut self, value: PostV1HrEmployeesCreateResponseAddress) -> Self {
    ...
    pub fn status(mut self, value: PostV1HrEmployeesCreateResponseStatus) -> Self {
    ...
    pub fn attributes(mut self, value: Vec<PostV1HrEmployeesCreateResponseAttributesItem>) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1HrEmployeesCreateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1HrEmployeesCreateResponseBuilder::id)
    /// - [`first_name`](PostV1HrEmployeesCreateResponseBuilder::first_name)
    /// - [`last_name`](PostV1HrEmployeesCreateResponseBuilder::last_name)
    /// - [`apply_npd`](PostV1HrEmployeesCreateResponseBuilder::apply_npd)
    /// - [`pension_accumulation`](PostV1HrEmployeesCreateResponseBuilder::pension_accumulation)
    /// - [`status`](PostV1HrEmployeesCreateResponseBuilder::status)
    /// - [`created_at`](PostV1HrEmployeesCreateResponseBuilder::created_at)
    pub fn build(self) -> Result<PostV1HrEmployeesCreateResponse, BuildError> {
        Ok(PostV1HrEmployeesCreateResponse {
