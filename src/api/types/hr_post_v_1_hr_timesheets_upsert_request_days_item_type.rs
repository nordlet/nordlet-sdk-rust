...
pub enum PostV1HrTimesheetsUpsertRequestDaysItemType {
    Work,
    BusinessTrip,
    Vacation,
    Sick,
...
impl Serialize for PostV1HrTimesheetsUpsertRequestDaysItemType {
...
impl<'de> Deserialize<'de> for PostV1HrTimesheetsUpsertRequestDaysItemType {
...
impl fmt::Display for PostV1HrTimesheetsUpsertRequestDaysItemType {
