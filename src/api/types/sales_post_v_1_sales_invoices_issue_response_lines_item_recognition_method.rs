...
pub enum PostV1SalesInvoicesIssueResponseLinesItemRecognitionMethod {
    PointInTime,
    Ratable,
    Milestone,
    PercentComplete,
...
impl Serialize for PostV1SalesInvoicesIssueResponseLinesItemRecognitionMethod {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesIssueResponseLinesItemRecognitionMethod {
...
impl fmt::Display for PostV1SalesInvoicesIssueResponseLinesItemRecognitionMethod {
