...
impl PostV1BankFeedsConnectionsCompleteResponseAccountsItem {
    pub fn builder() -> PostV1BankFeedsConnectionsCompleteResponseAccountsItemBuilder {
        <PostV1BankFeedsConnectionsCompleteResponseAccountsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1BankFeedsConnectionsCompleteResponseAccountsItemBuilder {
    id: Option<String>,
...
impl PostV1BankFeedsConnectionsCompleteResponseAccountsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1BankFeedsConnectionsCompleteResponseAccountsItem`].
    ...
    pub fn build(
        self,
    ) -> Result<PostV1BankFeedsConnectionsCompleteResponseAccountsItem, BuildError> {
        Ok(PostV1BankFeedsConnectionsCompleteResponseAccountsItem {
