...
pub struct PostV1PartnersVatReviewsResolveResponseDetails {
...
impl PostV1PartnersVatReviewsResolveResponseDetails {
    pub fn builder() -> PostV1PartnersVatReviewsResolveResponseDetailsBuilder {
        <PostV1PartnersVatReviewsResolveResponseDetailsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PartnersVatReviewsResolveResponseDetailsBuilder {
...
impl PostV1PartnersVatReviewsResolveResponseDetailsBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PartnersVatReviewsResolveResponseDetails`].
    pub fn build(self) -> Result<PostV1PartnersVatReviewsResolveResponseDetails, BuildError> {
        Ok(PostV1PartnersVatReviewsResolveResponseDetails {
