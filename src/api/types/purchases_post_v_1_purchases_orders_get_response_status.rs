...
pub enum PostV1PurchasesOrdersGetResponseStatus {
    Draft,
    Submitted,
    Approved,
    PartiallyReceived,
...
impl Serialize for PostV1PurchasesOrdersGetResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1PurchasesOrdersGetResponseStatus {
...
impl fmt::Display for PostV1PurchasesOrdersGetResponseStatus {
