...
pub enum PostV1BankImportTemplatesGetResponseType {
    Stripe,
    Iso20022,
    BankConnection,
...
impl Serialize for PostV1BankImportTemplatesGetResponseType {
...
impl<'de> Deserialize<'de> for PostV1BankImportTemplatesGetResponseType {
...
impl fmt::Display for PostV1BankImportTemplatesGetResponseType {
