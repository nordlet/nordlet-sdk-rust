...
pub struct PostV1PartnersFindOrCreateResponsePartner {
    #[serde(default)]
    pub id: String,
    pub r#type: PostV1PartnersFindOrCreateResponsePartnerType,
    #[serde(default)]
    pub name: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<PostV1PartnersFindOrCreateResponsePartnerAddress>,
    #[serde(rename = "correspondenceAddress")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub correspondence_address:
        Option<PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub legal_country_class: Option<PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass>,
...
impl PostV1PartnersFindOrCreateResponsePartner {
    pub fn builder() -> PostV1PartnersFindOrCreateResponsePartnerBuilder {
        <PostV1PartnersFindOrCreateResponsePartnerBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PartnersFindOrCreateResponsePartnerBuilder {
    id: Option<String>,
    r#type: Option<PostV1PartnersFindOrCreateResponsePartnerType>,
    name: Option<String>,
    code: Option<String>,
    ...
    address: Option<PostV1PartnersFindOrCreateResponsePartnerAddress>,
    correspondence_address: Option<PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress>,
    notes: Option<String>,
    ...
    legal_country_class: Option<PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass>,
    created_at: Option<String>,
    updated_at: Option<String>,
}

impl PostV1PartnersFindOrCreateResponsePartnerBuilder {
    pub fn id(mut self, value: impl Into<String>) -> Self {
        self.id = Some(value.into());
        self
    }

    pub fn r#type(mut self, value: PostV1PartnersFindOrCreateResponsePartnerType) -> Self {
    ...
    pub fn address(mut self, value: PostV1PartnersFindOrCreateResponsePartnerAddress) -> Self {
    ...
    pub fn correspondence_address(
        mut self,
        value: PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress,
    ) -> Self {
    ...
    pub fn legal_country_class(
        mut self,
        value: PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1PartnersFindOrCreateResponsePartner`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PartnersFindOrCreateResponsePartnerBuilder::id)
    /// - [`r#type`](PostV1PartnersFindOrCreateResponsePartnerBuilder::r#type)
    /// - [`name`](PostV1PartnersFindOrCreateResponsePartnerBuilder::name)
    /// - [`is_customer`](PostV1PartnersFindOrCreateResponsePartnerBuilder::is_customer)
    /// - [`is_supplier`](PostV1PartnersFindOrCreateResponsePartnerBuilder::is_supplier)
    /// - [`auto_debt_reminder`](PostV1PartnersFindOrCreateResponsePartnerBuilder::auto_debt_reminder)
    /// - [`is_employee`](PostV1PartnersFindOrCreateResponsePartnerBuilder::is_employee)
    /// - [`is_group_member`](PostV1PartnersFindOrCreateResponsePartnerBuilder::is_group_member)
    /// - [`is_active`](PostV1PartnersFindOrCreateResponsePartnerBuilder::is_active)
    /// - [`created_at`](PostV1PartnersFindOrCreateResponsePartnerBuilder::created_at)
    /// - [`updated_at`](PostV1PartnersFindOrCreateResponsePartnerBuilder::updated_at)
    pub fn build(self) -> Result<PostV1PartnersFindOrCreateResponsePartner, BuildError> {
        Ok(PostV1PartnersFindOrCreateResponsePartner {
