...
pub enum PostV1LeadsUpdateRequestStatus {
    New,
    Contacted,
    Qualified,
    Lost,
...
impl Serialize for PostV1LeadsUpdateRequestStatus {
...
impl<'de> Deserialize<'de> for PostV1LeadsUpdateRequestStatus {
...
impl fmt::Display for PostV1LeadsUpdateRequestStatus {
