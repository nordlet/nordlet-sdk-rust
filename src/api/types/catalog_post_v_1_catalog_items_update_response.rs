...
pub struct PostV1CatalogItemsUpdateResponse {
    ...
    pub tracking: PostV1CatalogItemsUpdateResponseTracking,
    #[serde(default)]
    pub name: String,
...
pub struct PostV1CatalogItemsUpdateResponseBuilder {
    ...
    tracking: Option<PostV1CatalogItemsUpdateResponseTracking>,
    name: Option<String>,
    code: Option<String>,
...
impl PostV1CatalogItemsUpdateResponseBuilder {
    ...
    pub fn tracking(mut self, value: PostV1CatalogItemsUpdateResponseTracking) -> Self {
    ...
    /// - [`tracking`](PostV1CatalogItemsUpdateResponseBuilder::tracking)
    ...
    /// - [`is_free_price`](PostV1CatalogItemsUpdateResponseBuilder::is_free_price)
    /// - [`is_returnable`](PostV1CatalogItemsUpdateResponseBuilder::is_returnable)
    /// - [`comment_required`](PostV1CatalogItemsUpdateResponseBuilder::comment_required)
