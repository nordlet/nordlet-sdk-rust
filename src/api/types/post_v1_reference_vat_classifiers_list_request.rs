...
pub struct PostV1ReferenceVatClassifiersListRequest {
...
impl PostV1ReferenceVatClassifiersListRequest {
    pub fn builder() -> PostV1ReferenceVatClassifiersListRequestBuilder {
        <PostV1ReferenceVatClassifiersListRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1ReferenceVatClassifiersListRequestBuilder {
    page: Option<i64>,
...
impl PostV1ReferenceVatClassifiersListRequestBuilder {
    ...
    pub fn sort(mut self, value: Vec<PostV1ReferenceVatClassifiersListRequestSortItem>) -> Self {
    ...
    pub fn filter(
        mut self,
        value: Vec<PostV1ReferenceVatClassifiersListRequestFilterItem>,
    ) -> Self {
