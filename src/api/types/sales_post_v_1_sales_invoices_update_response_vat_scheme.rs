...
pub enum PostV1SalesInvoicesUpdateResponseVatScheme {
    Domestic,
    IntraEuB2B,
    ReverseCharge,
    OssUnion,
...
impl Serialize for PostV1SalesInvoicesUpdateResponseVatScheme {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesUpdateResponseVatScheme {
...
impl fmt::Display for PostV1SalesInvoicesUpdateResponseVatScheme {
