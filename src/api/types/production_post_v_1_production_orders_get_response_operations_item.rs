...
pub struct PostV1ProductionOrdersGetResponseOperationsItem {
    #[serde(default)]
    pub id: String,
...
impl PostV1ProductionOrdersGetResponseOperationsItem {
    pub fn builder() -> PostV1ProductionOrdersGetResponseOperationsItemBuilder {
        <PostV1ProductionOrdersGetResponseOperationsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1ProductionOrdersGetResponseOperationsItemBuilder {
    id: Option<String>,
...
impl PostV1ProductionOrdersGetResponseOperationsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1ProductionOrdersGetResponseOperationsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1ProductionOrdersGetResponseOperationsItemBuilder::id)
    /// - [`work_center_id`](PostV1ProductionOrdersGetResponseOperationsItemBuilder::work_center_id)
    /// - [`sequence`](PostV1ProductionOrdersGetResponseOperationsItemBuilder::sequence)
    /// - [`name`](PostV1ProductionOrdersGetResponseOperationsItemBuilder::name)
    /// - [`planned_minutes`](PostV1ProductionOrdersGetResponseOperationsItemBuilder::planned_minutes)
    /// - [`cost_per_hour`](PostV1ProductionOrdersGetResponseOperationsItemBuilder::cost_per_hour)
    pub fn build(self) -> Result<PostV1ProductionOrdersGetResponseOperationsItem, BuildError> {
        Ok(PostV1ProductionOrdersGetResponseOperationsItem {
