...
pub struct PostV1BankSettlementsGetResponse {
    #[serde(default)]
    pub id: String,
    ...
    pub status: PostV1BankSettlementsGetResponseStatus,
    ...
    #[serde(default)]
    pub lines: Vec<PostV1BankSettlementsGetResponseLinesItem>,
}

impl PostV1BankSettlementsGetResponse {
    pub fn builder() -> PostV1BankSettlementsGetResponseBuilder {
        <PostV1BankSettlementsGetResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1BankSettlementsGetResponseBuilder {
    id: Option<String>,
    ...
    lines: Option<Vec<PostV1BankSettlementsGetResponseLinesItem>>,
}

impl PostV1BankSettlementsGetResponseBuilder {
    ...
    pub fn status(mut self, value: PostV1BankSettlementsGetResponseStatus) -> Self {
    ...
    pub fn lines(mut self, value: Vec<PostV1BankSettlementsGetResponseLinesItem>) -> Self {
        self.lines = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1BankSettlementsGetResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1BankSettlementsGetResponseBuilder::id)
    /// - [`bank_account_id`](PostV1BankSettlementsGetResponseBuilder::bank_account_id)
    /// - [`provider`](PostV1BankSettlementsGetResponseBuilder::provider)
    /// - [`payout_id`](PostV1BankSettlementsGetResponseBuilder::payout_id)
    /// - [`currency`](PostV1BankSettlementsGetResponseBuilder::currency)
    /// - [`gross_total`](PostV1BankSettlementsGetResponseBuilder::gross_total)
    /// - [`fee_total`](PostV1BankSettlementsGetResponseBuilder::fee_total)
    /// - [`net_total`](PostV1BankSettlementsGetResponseBuilder::net_total)
    /// - [`status`](PostV1BankSettlementsGetResponseBuilder::status)
    /// - [`line_count`](PostV1BankSettlementsGetResponseBuilder::line_count)
    /// - [`matched_count`](PostV1BankSettlementsGetResponseBuilder::matched_count)
    /// - [`unmatched_count`](PostV1BankSettlementsGetResponseBuilder::unmatched_count)
    /// - [`created_at`](PostV1BankSettlementsGetResponseBuilder::created_at)
    /// - [`updated_at`](PostV1BankSettlementsGetResponseBuilder::updated_at)
    /// - [`lines`](PostV1BankSettlementsGetResponseBuilder::lines)
    pub fn build(self) -> Result<PostV1BankSettlementsGetResponse, BuildError> {
        Ok(PostV1BankSettlementsGetResponse {
