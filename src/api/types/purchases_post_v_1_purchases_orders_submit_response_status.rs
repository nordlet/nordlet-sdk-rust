...
pub enum PostV1PurchasesOrdersSubmitResponseStatus {
    Draft,
    Submitted,
    Approved,
    PartiallyReceived,
...
impl Serialize for PostV1PurchasesOrdersSubmitResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1PurchasesOrdersSubmitResponseStatus {
...
impl fmt::Display for PostV1PurchasesOrdersSubmitResponseStatus {
