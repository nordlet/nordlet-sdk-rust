...
pub enum PostV1LeadsCreateRequestStatus {
    New,
    Contacted,
    Qualified,
    Lost,
...
impl Serialize for PostV1LeadsCreateRequestStatus {
...
impl<'de> Deserialize<'de> for PostV1LeadsCreateRequestStatus {
...
impl fmt::Display for PostV1LeadsCreateRequestStatus {
