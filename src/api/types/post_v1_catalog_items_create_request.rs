...
pub struct PostV1CatalogItemsCreateRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub components: Option<Vec<PostV1CatalogItemsCreateRequestComponentsItem>>,
    #[serde(rename = "kindId")]
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pos_flags: Option<HashMap<String, bool>>,
}

impl PostV1CatalogItemsCreateRequest {
    pub fn builder() -> PostV1CatalogItemsCreateRequestBuilder {
        <PostV1CatalogItemsCreateRequestBuilder as Default>::default()
    }
}
...
pub struct PostV1CatalogItemsCreateRequestBuilder {
    ...
    pos_flags: Option<HashMap<String, bool>>,
}
...
impl PostV1CatalogItemsCreateRequestBuilder {
    ...
    pub fn components(mut self, value: Vec<PostV1CatalogItemsCreateRequestComponentsItem>) -> Self {
    ...
    pub fn pos_flags(mut self, value: HashMap<String, bool>) -> Self {
        self.pos_flags = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1CatalogItemsCreateRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](PostV1CatalogItemsCreateRequestBuilder::name)
