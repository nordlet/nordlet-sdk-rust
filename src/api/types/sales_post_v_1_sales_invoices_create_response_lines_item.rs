...
pub struct PostV1SalesInvoicesCreateResponseLinesItem {
    ...
    pub recognition_method: PostV1SalesInvoicesCreateResponseLinesItemRecognitionMethod,
    ...
    pub recognition_milestones:
        Option<Vec<PostV1SalesInvoicesCreateResponseLinesItemRecognitionMilestonesItem>>,
...
pub struct PostV1SalesInvoicesCreateResponseLinesItemBuilder {
    ...
    recognition_method: Option<PostV1SalesInvoicesCreateResponseLinesItemRecognitionMethod>,
...
impl PostV1SalesInvoicesCreateResponseLinesItemBuilder {
    ...
    pub fn recognition_method(
        mut self,
        value: PostV1SalesInvoicesCreateResponseLinesItemRecognitionMethod,
    ) -> Self {
    ...
    pub fn recognition_milestones(
        mut self,
        value: Vec<PostV1SalesInvoicesCreateResponseLinesItemRecognitionMilestonesItem>,
    ) -> Self {
    ...
    /// - [`recognition_method`](PostV1SalesInvoicesCreateResponseLinesItemBuilder::recognition_method)
