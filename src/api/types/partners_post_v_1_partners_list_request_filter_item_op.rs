...
pub enum PostV1PartnersListRequestFilterItemOp {
    Eq,
    Ne,
    Contains,
    Gte,
...
impl Serialize for PostV1PartnersListRequestFilterItemOp {
...
impl<'de> Deserialize<'de> for PostV1PartnersListRequestFilterItemOp {
...
impl fmt::Display for PostV1PartnersListRequestFilterItemOp {
