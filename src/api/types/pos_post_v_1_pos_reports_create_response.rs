...
pub struct PostV1PosReportsCreateResponse {
    #[serde(default)]
    pub id: String,
    ...
    #[serde(default)]
    pub vat_lines: Vec<PostV1PosReportsCreateResponseVatLinesItem>,
}

impl PostV1PosReportsCreateResponse {
    pub fn builder() -> PostV1PosReportsCreateResponseBuilder {
        <PostV1PosReportsCreateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PosReportsCreateResponseBuilder {
    id: Option<String>,
    ...
    vat_lines: Option<Vec<PostV1PosReportsCreateResponseVatLinesItem>>,
}

impl PostV1PosReportsCreateResponseBuilder {
    ...
    pub fn vat_lines(mut self, value: Vec<PostV1PosReportsCreateResponseVatLinesItem>) -> Self {
        self.vat_lines = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1PosReportsCreateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PosReportsCreateResponseBuilder::id)
    /// - [`report_number`](PostV1PosReportsCreateResponseBuilder::report_number)
    /// - [`date`](PostV1PosReportsCreateResponseBuilder::date)
    /// - [`net_total`](PostV1PosReportsCreateResponseBuilder::net_total)
    /// - [`vat_total`](PostV1PosReportsCreateResponseBuilder::vat_total)
    /// - [`gross_total`](PostV1PosReportsCreateResponseBuilder::gross_total)
    /// - [`cash_amount`](PostV1PosReportsCreateResponseBuilder::cash_amount)
    /// - [`card_amount`](PostV1PosReportsCreateResponseBuilder::card_amount)
    /// - [`created_at`](PostV1PosReportsCreateResponseBuilder::created_at)
    /// - [`vat_lines`](PostV1PosReportsCreateResponseBuilder::vat_lines)
    pub fn build(self) -> Result<PostV1PosReportsCreateResponse, BuildError> {
        Ok(PostV1PosReportsCreateResponse {
