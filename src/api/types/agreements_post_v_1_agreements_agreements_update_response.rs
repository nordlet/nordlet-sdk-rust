...
pub struct PostV1AgreementsAgreementsUpdateResponse {
    ...
    pub kind: PostV1AgreementsAgreementsUpdateResponseKind,
...
pub struct PostV1AgreementsAgreementsUpdateResponseBuilder {
    ...
    kind: Option<PostV1AgreementsAgreementsUpdateResponseKind>,
...
impl PostV1AgreementsAgreementsUpdateResponseBuilder {
    ...
    pub fn kind(mut self, value: PostV1AgreementsAgreementsUpdateResponseKind) -> Self {
    ...
    /// - [`kind`](PostV1AgreementsAgreementsUpdateResponseBuilder::kind)
