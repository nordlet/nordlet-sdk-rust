...
pub enum PostV1PurchasesOrdersCancelResponseStatus {
    Draft,
    Submitted,
    Approved,
    PartiallyReceived,
...
impl Serialize for PostV1PurchasesOrdersCancelResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1PurchasesOrdersCancelResponseStatus {
...
impl fmt::Display for PostV1PurchasesOrdersCancelResponseStatus {
