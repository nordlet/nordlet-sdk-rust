...
pub enum PostV1SalesInvoicesIssueResponseVatScheme {
    Domestic,
    IntraEuB2B,
    ReverseCharge,
    OssUnion,
...
impl Serialize for PostV1SalesInvoicesIssueResponseVatScheme {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesIssueResponseVatScheme {
...
impl fmt::Display for PostV1SalesInvoicesIssueResponseVatScheme {
