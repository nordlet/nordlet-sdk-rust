...
pub enum PostV1SalesInvoicesLockResponseVatScheme {
    Domestic,
    IntraEuB2B,
    ReverseCharge,
    OssUnion,
...
impl Serialize for PostV1SalesInvoicesLockResponseVatScheme {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesLockResponseVatScheme {
...
impl fmt::Display for PostV1SalesInvoicesLockResponseVatScheme {
