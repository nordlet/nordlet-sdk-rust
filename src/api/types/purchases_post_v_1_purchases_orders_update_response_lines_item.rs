...
pub struct PostV1PurchasesOrdersUpdateResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1PurchasesOrdersUpdateResponseLinesItem {
    pub fn builder() -> PostV1PurchasesOrdersUpdateResponseLinesItemBuilder {
        <PostV1PurchasesOrdersUpdateResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesOrdersUpdateResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1PurchasesOrdersUpdateResponseLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesOrdersUpdateResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::id)
    /// - [`description`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::quantity)
    /// - [`received_qty`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::received_qty)
    /// - [`remaining_qty`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::remaining_qty)
    /// - [`vat_rate_percent`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1PurchasesOrdersUpdateResponseLinesItemBuilder::sort_order)
    pub fn build(self) -> Result<PostV1PurchasesOrdersUpdateResponseLinesItem, BuildError> {
        Ok(PostV1PurchasesOrdersUpdateResponseLinesItem {
