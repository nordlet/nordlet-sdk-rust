...
pub enum PostV1SalesInvoicesCreateResponseLinesItemRecognitionMethod {
    PointInTime,
    Ratable,
    Milestone,
    PercentComplete,
...
impl Serialize for PostV1SalesInvoicesCreateResponseLinesItemRecognitionMethod {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesCreateResponseLinesItemRecognitionMethod {
...
impl fmt::Display for PostV1SalesInvoicesCreateResponseLinesItemRecognitionMethod {
