...
pub enum PostV1LeadsListResponseRowsItemStatus {
    New,
    Contacted,
    Qualified,
    Lost,
...
impl Serialize for PostV1LeadsListResponseRowsItemStatus {
...
impl<'de> Deserialize<'de> for PostV1LeadsListResponseRowsItemStatus {
...
impl fmt::Display for PostV1LeadsListResponseRowsItemStatus {
