...
pub enum PostV1ReferenceVatResolveRequestSupplyType {
    Goods,
    Services,
    Digital,
...
impl Serialize for PostV1ReferenceVatResolveRequestSupplyType {
...
impl<'de> Deserialize<'de> for PostV1ReferenceVatResolveRequestSupplyType {
...
impl fmt::Display for PostV1ReferenceVatResolveRequestSupplyType {
