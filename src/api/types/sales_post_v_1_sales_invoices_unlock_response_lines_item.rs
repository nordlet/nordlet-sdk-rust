...
pub struct PostV1SalesInvoicesUnlockResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
    ...
    pub recognition_method: PostV1SalesInvoicesUnlockResponseLinesItemRecognitionMethod,
    ...
    pub recognition_milestones:
        Option<Vec<PostV1SalesInvoicesUnlockResponseLinesItemRecognitionMilestonesItem>>,
...
impl PostV1SalesInvoicesUnlockResponseLinesItem {
    pub fn builder() -> PostV1SalesInvoicesUnlockResponseLinesItemBuilder {
        <PostV1SalesInvoicesUnlockResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesInvoicesUnlockResponseLinesItemBuilder {
    id: Option<String>,
    ...
    recognition_method: Option<PostV1SalesInvoicesUnlockResponseLinesItemRecognitionMethod>,
...
impl PostV1SalesInvoicesUnlockResponseLinesItemBuilder {
    ...
    pub fn recognition_method(
        mut self,
        value: PostV1SalesInvoicesUnlockResponseLinesItemRecognitionMethod,
    ) -> Self {
    ...
    pub fn recognition_milestones(
        mut self,
        value: Vec<PostV1SalesInvoicesUnlockResponseLinesItemRecognitionMilestonesItem>,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1SalesInvoicesUnlockResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1SalesInvoicesUnlockResponseLinesItemBuilder::id)
    /// - [`description`](PostV1SalesInvoicesUnlockResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1SalesInvoicesUnlockResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1SalesInvoicesUnlockResponseLinesItemBuilder::quantity)
    /// - [`vat_rate_percent`](PostV1SalesInvoicesUnlockResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1SalesInvoicesUnlockResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1SalesInvoicesUnlockResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1SalesInvoicesUnlockResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1SalesInvoicesUnlockResponseLinesItemBuilder::sort_order)
    /// - [`recognition_method`](PostV1SalesInvoicesUnlockResponseLinesItemBuilder::recognition_method)
    pub fn build(self) -> Result<PostV1SalesInvoicesUnlockResponseLinesItem, BuildError> {
        Ok(PostV1SalesInvoicesUnlockResponseLinesItem {
