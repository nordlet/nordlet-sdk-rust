...
pub struct PostV1SalesInvoicesCreateRequestLinesItem {
    #[serde(rename = "itemId")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quantity: Option<PostV1SalesInvoicesCreateRequestLinesItemQuantity>,
...
impl PostV1SalesInvoicesCreateRequestLinesItem {
    pub fn builder() -> PostV1SalesInvoicesCreateRequestLinesItemBuilder {
        <PostV1SalesInvoicesCreateRequestLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesInvoicesCreateRequestLinesItemBuilder {
    item_id: Option<String>,
    description: Option<String>,
    unit: Option<String>,
    quantity: Option<PostV1SalesInvoicesCreateRequestLinesItemQuantity>,
...
impl PostV1SalesInvoicesCreateRequestLinesItemBuilder {
    ...
    pub fn quantity(mut self, value: PostV1SalesInvoicesCreateRequestLinesItemQuantity) -> Self {
