...
pub enum PostV1LeadsCreateResponseStatus {
    New,
    Contacted,
    Qualified,
    Lost,
...
impl Serialize for PostV1LeadsCreateResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1LeadsCreateResponseStatus {
...
impl fmt::Display for PostV1LeadsCreateResponseStatus {
