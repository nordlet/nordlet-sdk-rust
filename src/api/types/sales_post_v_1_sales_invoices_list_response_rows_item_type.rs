...
pub enum PostV1SalesInvoicesListResponseRowsItemType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1SalesInvoicesListResponseRowsItemType {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesListResponseRowsItemType {
...
impl fmt::Display for PostV1SalesInvoicesListResponseRowsItemType {
