...
pub struct PostV1SalesInvoicesLockResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
    ...
    pub recognition_method: PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod,
    ...
    pub recognition_milestones:
        Option<Vec<PostV1SalesInvoicesLockResponseLinesItemRecognitionMilestonesItem>>,
...
impl PostV1SalesInvoicesLockResponseLinesItem {
    pub fn builder() -> PostV1SalesInvoicesLockResponseLinesItemBuilder {
        <PostV1SalesInvoicesLockResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesInvoicesLockResponseLinesItemBuilder {
    id: Option<String>,
    ...
    recognition_method: Option<PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod>,
...
impl PostV1SalesInvoicesLockResponseLinesItemBuilder {
    ...
    pub fn recognition_method(
        mut self,
        value: PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod,
    ) -> Self {
    ...
    pub fn recognition_milestones(
        mut self,
        value: Vec<PostV1SalesInvoicesLockResponseLinesItemRecognitionMilestonesItem>,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1SalesInvoicesLockResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1SalesInvoicesLockResponseLinesItemBuilder::id)
    /// - [`description`](PostV1SalesInvoicesLockResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1SalesInvoicesLockResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1SalesInvoicesLockResponseLinesItemBuilder::quantity)
    /// - [`vat_rate_percent`](PostV1SalesInvoicesLockResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1SalesInvoicesLockResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1SalesInvoicesLockResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1SalesInvoicesLockResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1SalesInvoicesLockResponseLinesItemBuilder::sort_order)
    /// - [`recognition_method`](PostV1SalesInvoicesLockResponseLinesItemBuilder::recognition_method)
    pub fn build(self) -> Result<PostV1SalesInvoicesLockResponseLinesItem, BuildError> {
        Ok(PostV1SalesInvoicesLockResponseLinesItem {
