...
pub enum PostV1PartnersVatReviewsResolveResponseReason {
    Invalid,
    ServiceError,
    NameMismatch,
...
impl Serialize for PostV1PartnersVatReviewsResolveResponseReason {
...
impl<'de> Deserialize<'de> for PostV1PartnersVatReviewsResolveResponseReason {
...
impl fmt::Display for PostV1PartnersVatReviewsResolveResponseReason {
