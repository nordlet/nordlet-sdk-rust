...
pub struct PostV1HrEmployeesCreateRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<PostV1HrEmployeesCreateRequestAddress>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl PostV1HrEmployeesCreateRequest {
    pub fn builder() -> PostV1HrEmployeesCreateRequestBuilder {
        <PostV1HrEmployeesCreateRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1HrEmployeesCreateRequestBuilder {
    code: Option<String>,
...
impl PostV1HrEmployeesCreateRequestBuilder {
    ...
    pub fn address(mut self, value: PostV1HrEmployeesCreateRequestAddress) -> Self {
    ...
    /// - [`last_name`](PostV1HrEmployeesCreateRequestBuilder::last_name)
    pub fn build(self) -> Result<PostV1HrEmployeesCreateRequest, BuildError> {
        Ok(PostV1HrEmployeesCreateRequest {
            code: self.code,
            first_name: self
                .first_name
