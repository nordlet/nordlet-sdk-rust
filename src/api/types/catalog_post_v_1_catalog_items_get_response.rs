...
pub struct PostV1CatalogItemsGetResponse {
    #[serde(default)]
    pub id: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub translations:
        Option<HashMap<String, Option<PostV1CatalogItemsGetResponseTranslationsValue>>>,
    #[serde(default)]
    pub components: Vec<PostV1CatalogItemsGetResponseComponentsItem>,
    #[serde(rename = "kindId")]
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl PostV1CatalogItemsGetResponse {
    pub fn builder() -> PostV1CatalogItemsGetResponseBuilder {
        <PostV1CatalogItemsGetResponseBuilder as Default>::default()
    }
}
...
pub struct PostV1CatalogItemsGetResponseBuilder {
    ...
    translations: Option<HashMap<String, Option<PostV1CatalogItemsGetResponseTranslationsValue>>>,
    components: Option<Vec<PostV1CatalogItemsGetResponseComponentsItem>>,
...
impl PostV1CatalogItemsGetResponseBuilder {
    ...
    pub fn translations(
        mut self,
        value: HashMap<String, Option<PostV1CatalogItemsGetResponseTranslationsValue>>,
    ) -> Self {
        self.translations = Some(value);
        self
    }

    pub fn components(mut self, value: Vec<PostV1CatalogItemsGetResponseComponentsItem>) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1CatalogItemsGetResponse`].
    ...
    /// - [`is_free_price`](PostV1CatalogItemsGetResponseBuilder::is_free_price)
    /// - [`is_returnable`](PostV1CatalogItemsGetResponseBuilder::is_returnable)
    /// - [`comment_required`](PostV1CatalogItemsGetResponseBuilder::comment_required)
    /// - [`created_at`](PostV1CatalogItemsGetResponseBuilder::created_at)
    /// - [`updated_at`](PostV1CatalogItemsGetResponseBuilder::updated_at)
    pub fn build(self) -> Result<PostV1CatalogItemsGetResponse, BuildError> {
        Ok(PostV1CatalogItemsGetResponse {
