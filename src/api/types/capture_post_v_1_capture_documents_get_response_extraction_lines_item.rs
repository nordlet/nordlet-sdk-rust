...
pub struct PostV1CaptureDocumentsGetResponseExtractionLinesItem {
    #[serde(default)]
...
impl PostV1CaptureDocumentsGetResponseExtractionLinesItem {
    pub fn builder() -> PostV1CaptureDocumentsGetResponseExtractionLinesItemBuilder {
        <PostV1CaptureDocumentsGetResponseExtractionLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1CaptureDocumentsGetResponseExtractionLinesItemBuilder {
...
impl PostV1CaptureDocumentsGetResponseExtractionLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1CaptureDocumentsGetResponseExtractionLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`description`](PostV1CaptureDocumentsGetResponseExtractionLinesItemBuilder::description)
    /// - [`quantity`](PostV1CaptureDocumentsGetResponseExtractionLinesItemBuilder::quantity)
    pub fn build(self) -> Result<PostV1CaptureDocumentsGetResponseExtractionLinesItem, BuildError> {
        Ok(PostV1CaptureDocumentsGetResponseExtractionLinesItem {
            description: self
                .description
