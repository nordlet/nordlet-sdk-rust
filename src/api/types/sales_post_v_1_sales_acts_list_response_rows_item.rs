...
pub struct PostV1SalesActsListResponseRowsItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "partnerId")]
    #[serde(default)]
    pub partner_id: String,
    pub r#type: PostV1SalesActsListResponseRowsItemType,
    pub status: PostV1SalesActsListResponseRowsItemStatus,
    #[serde(default)]
    pub series: String,
...
impl PostV1SalesActsListResponseRowsItem {
    pub fn builder() -> PostV1SalesActsListResponseRowsItemBuilder {
        <PostV1SalesActsListResponseRowsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesActsListResponseRowsItemBuilder {
    id: Option<String>,
    partner_id: Option<String>,
    r#type: Option<PostV1SalesActsListResponseRowsItemType>,
    status: Option<PostV1SalesActsListResponseRowsItemStatus>,
...
impl PostV1SalesActsListResponseRowsItemBuilder {
    ...
    pub fn r#type(mut self, value: PostV1SalesActsListResponseRowsItemType) -> Self {
        self.r#type = Some(value);
        self
    }

    pub fn status(mut self, value: PostV1SalesActsListResponseRowsItemStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1SalesActsListResponseRowsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1SalesActsListResponseRowsItemBuilder::id)
    /// - [`partner_id`](PostV1SalesActsListResponseRowsItemBuilder::partner_id)
    /// - [`r#type`](PostV1SalesActsListResponseRowsItemBuilder::r#type)
    /// - [`status`](PostV1SalesActsListResponseRowsItemBuilder::status)
    /// - [`series`](PostV1SalesActsListResponseRowsItemBuilder::series)
    /// - [`document_date`](PostV1SalesActsListResponseRowsItemBuilder::document_date)
    /// - [`created_at`](PostV1SalesActsListResponseRowsItemBuilder::created_at)
    /// - [`updated_at`](PostV1SalesActsListResponseRowsItemBuilder::updated_at)
    pub fn build(self) -> Result<PostV1SalesActsListResponseRowsItem, BuildError> {
        Ok(PostV1SalesActsListResponseRowsItem {
