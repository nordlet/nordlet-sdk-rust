...
pub enum PostV1OperationTypesListResponseRowsItemInvoiceType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1OperationTypesListResponseRowsItemInvoiceType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        match self {
            Self::Invoice => serializer.serialize_str("invoice"),
            Self::CreditNote => serializer.serialize_str("credit_note"),
            Self::Proforma => serializer.serialize_str("proforma"),
...
impl<'de> Deserialize<'de> for PostV1OperationTypesListResponseRowsItemInvoiceType {
...
impl fmt::Display for PostV1OperationTypesListResponseRowsItemInvoiceType {
