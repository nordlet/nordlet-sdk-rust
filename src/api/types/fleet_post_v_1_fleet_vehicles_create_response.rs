...
pub struct PostV1FleetVehiclesCreateResponse {
    #[serde(default)]
    pub id: String,
    ...
    pub status: PostV1FleetVehiclesCreateResponseStatus,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub notes: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub documents: Option<Vec<PostV1FleetVehiclesCreateResponseDocumentsItem>>,
    #[serde(rename = "currentAssignment")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub current_assignment: Option<PostV1FleetVehiclesCreateResponseCurrentAssignment>,
    #[serde(rename = "createdAt")]
    #[serde(default)]
    pub created_at: String,
}

impl PostV1FleetVehiclesCreateResponse {
    pub fn builder() -> PostV1FleetVehiclesCreateResponseBuilder {
        <PostV1FleetVehiclesCreateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1FleetVehiclesCreateResponseBuilder {
    id: Option<String>,
    ...
    status: Option<PostV1FleetVehiclesCreateResponseStatus>,
    notes: Option<String>,
    documents: Option<Vec<PostV1FleetVehiclesCreateResponseDocumentsItem>>,
    current_assignment: Option<PostV1FleetVehiclesCreateResponseCurrentAssignment>,
    created_at: Option<String>,
}

impl PostV1FleetVehiclesCreateResponseBuilder {
    ...
    pub fn status(mut self, value: PostV1FleetVehiclesCreateResponseStatus) -> Self {
    ...
    pub fn documents(mut self, value: Vec<PostV1FleetVehiclesCreateResponseDocumentsItem>) -> Self {
    ...
    pub fn current_assignment(
        mut self,
        value: PostV1FleetVehiclesCreateResponseCurrentAssignment,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1FleetVehiclesCreateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1FleetVehiclesCreateResponseBuilder::id)
    /// - [`plate_number`](PostV1FleetVehiclesCreateResponseBuilder::plate_number)
    /// - [`make`](PostV1FleetVehiclesCreateResponseBuilder::make)
    /// - [`model`](PostV1FleetVehiclesCreateResponseBuilder::model)
    /// - [`market_value`](PostV1FleetVehiclesCreateResponseBuilder::market_value)
    /// - [`status`](PostV1FleetVehiclesCreateResponseBuilder::status)
    /// - [`created_at`](PostV1FleetVehiclesCreateResponseBuilder::created_at)
    pub fn build(self) -> Result<PostV1FleetVehiclesCreateResponse, BuildError> {
        Ok(PostV1FleetVehiclesCreateResponse {
