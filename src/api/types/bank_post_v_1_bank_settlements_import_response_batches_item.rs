...
pub struct PostV1BankSettlementsImportResponseBatchesItem {
    #[serde(default)]
    pub id: String,
    ...
    pub status: PostV1BankSettlementsImportResponseBatchesItemStatus,
...
impl PostV1BankSettlementsImportResponseBatchesItem {
    pub fn builder() -> PostV1BankSettlementsImportResponseBatchesItemBuilder {
        <PostV1BankSettlementsImportResponseBatchesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1BankSettlementsImportResponseBatchesItemBuilder {
    id: Option<String>,
...
impl PostV1BankSettlementsImportResponseBatchesItemBuilder {
    ...
    pub fn status(mut self, value: PostV1BankSettlementsImportResponseBatchesItemStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1BankSettlementsImportResponseBatchesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1BankSettlementsImportResponseBatchesItemBuilder::id)
    /// - [`bank_account_id`](PostV1BankSettlementsImportResponseBatchesItemBuilder::bank_account_id)
    /// - [`provider`](PostV1BankSettlementsImportResponseBatchesItemBuilder::provider)
    /// - [`payout_id`](PostV1BankSettlementsImportResponseBatchesItemBuilder::payout_id)
    /// - [`currency`](PostV1BankSettlementsImportResponseBatchesItemBuilder::currency)
    /// - [`gross_total`](PostV1BankSettlementsImportResponseBatchesItemBuilder::gross_total)
    /// - [`fee_total`](PostV1BankSettlementsImportResponseBatchesItemBuilder::fee_total)
    /// - [`net_total`](PostV1BankSettlementsImportResponseBatchesItemBuilder::net_total)
    /// - [`status`](PostV1BankSettlementsImportResponseBatchesItemBuilder::status)
    /// - [`line_count`](PostV1BankSettlementsImportResponseBatchesItemBuilder::line_count)
    /// - [`matched_count`](PostV1BankSettlementsImportResponseBatchesItemBuilder::matched_count)
    /// - [`unmatched_count`](PostV1BankSettlementsImportResponseBatchesItemBuilder::unmatched_count)
    /// - [`created_at`](PostV1BankSettlementsImportResponseBatchesItemBuilder::created_at)
    /// - [`updated_at`](PostV1BankSettlementsImportResponseBatchesItemBuilder::updated_at)
    pub fn build(self) -> Result<PostV1BankSettlementsImportResponseBatchesItem, BuildError> {
        Ok(PostV1BankSettlementsImportResponseBatchesItem {
