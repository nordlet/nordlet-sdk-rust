...
pub struct PostV1AssetsAssetsModernizeResponse {
    #[serde(default)]
    pub id: String,
    ...
    pub status: PostV1AssetsAssetsModernizeResponseStatus,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub notes: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub documents: Option<Vec<PostV1AssetsAssetsModernizeResponseDocumentsItem>>,
    #[serde(rename = "createdAt")]
    #[serde(default)]
    pub created_at: String,
}

impl PostV1AssetsAssetsModernizeResponse {
    pub fn builder() -> PostV1AssetsAssetsModernizeResponseBuilder {
        <PostV1AssetsAssetsModernizeResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1AssetsAssetsModernizeResponseBuilder {
    id: Option<String>,
    ...
    status: Option<PostV1AssetsAssetsModernizeResponseStatus>,
    notes: Option<String>,
    documents: Option<Vec<PostV1AssetsAssetsModernizeResponseDocumentsItem>>,
    created_at: Option<String>,
}

impl PostV1AssetsAssetsModernizeResponseBuilder {
    ...
    pub fn status(mut self, value: PostV1AssetsAssetsModernizeResponseStatus) -> Self {
    ...
    pub fn documents(
        mut self,
        value: Vec<PostV1AssetsAssetsModernizeResponseDocumentsItem>,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1AssetsAssetsModernizeResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1AssetsAssetsModernizeResponseBuilder::id)
    /// - [`group_id`](PostV1AssetsAssetsModernizeResponseBuilder::group_id)
    /// - [`code`](PostV1AssetsAssetsModernizeResponseBuilder::code)
    /// - [`name`](PostV1AssetsAssetsModernizeResponseBuilder::name)
    /// - [`acquisition_date`](PostV1AssetsAssetsModernizeResponseBuilder::acquisition_date)
    /// - [`depreciation_start_date`](PostV1AssetsAssetsModernizeResponseBuilder::depreciation_start_date)
    /// - [`acquisition_cost`](PostV1AssetsAssetsModernizeResponseBuilder::acquisition_cost)
    /// - [`salvage_value`](PostV1AssetsAssetsModernizeResponseBuilder::salvage_value)
    /// - [`useful_life_months`](PostV1AssetsAssetsModernizeResponseBuilder::useful_life_months)
    /// - [`total_cost`](PostV1AssetsAssetsModernizeResponseBuilder::total_cost)
    /// - [`accumulated_depreciation`](PostV1AssetsAssetsModernizeResponseBuilder::accumulated_depreciation)
    /// - [`net_book_value`](PostV1AssetsAssetsModernizeResponseBuilder::net_book_value)
    /// - [`depreciated_months`](PostV1AssetsAssetsModernizeResponseBuilder::depreciated_months)
    /// - [`total_life_months`](PostV1AssetsAssetsModernizeResponseBuilder::total_life_months)
    /// - [`status`](PostV1AssetsAssetsModernizeResponseBuilder::status)
    /// - [`created_at`](PostV1AssetsAssetsModernizeResponseBuilder::created_at)
    pub fn build(self) -> Result<PostV1AssetsAssetsModernizeResponse, BuildError> {
        Ok(PostV1AssetsAssetsModernizeResponse {
