...
pub enum PostV1SalesInvoicesLockResponseType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1SalesInvoicesLockResponseType {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesLockResponseType {
...
impl fmt::Display for PostV1SalesInvoicesLockResponseType {
