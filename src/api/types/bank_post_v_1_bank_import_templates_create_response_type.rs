...
pub enum PostV1BankImportTemplatesCreateResponseType {
    Stripe,
    Iso20022,
    BankConnection,
...
impl Serialize for PostV1BankImportTemplatesCreateResponseType {
...
impl<'de> Deserialize<'de> for PostV1BankImportTemplatesCreateResponseType {
...
impl fmt::Display for PostV1BankImportTemplatesCreateResponseType {
