...
pub struct PostV1PurchasesOrdersUpdateRequestLinesItem {
    #[serde(rename = "itemId")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quantity: Option<PostV1PurchasesOrdersUpdateRequestLinesItemQuantity>,
...
impl PostV1PurchasesOrdersUpdateRequestLinesItem {
    pub fn builder() -> PostV1PurchasesOrdersUpdateRequestLinesItemBuilder {
        <PostV1PurchasesOrdersUpdateRequestLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesOrdersUpdateRequestLinesItemBuilder {
    item_id: Option<String>,
    description: Option<String>,
    unit: Option<String>,
    quantity: Option<PostV1PurchasesOrdersUpdateRequestLinesItemQuantity>,
...
impl PostV1PurchasesOrdersUpdateRequestLinesItemBuilder {
    ...
    pub fn quantity(mut self, value: PostV1PurchasesOrdersUpdateRequestLinesItemQuantity) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesOrdersUpdateRequestLinesItem`].
    pub fn build(self) -> Result<PostV1PurchasesOrdersUpdateRequestLinesItem, BuildError> {
        Ok(PostV1PurchasesOrdersUpdateRequestLinesItem {
