...
pub struct PostV1LedgerOwnersUpdateResponse {
    #[serde(default)]
    pub id: String,
    #[serde(default)]
    pub name: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<PostV1LedgerOwnersUpdateResponseAddress>,
    #[serde(rename = "createdAt")]
    #[serde(default)]
    pub created_at: String,
}

impl PostV1LedgerOwnersUpdateResponse {
    pub fn builder() -> PostV1LedgerOwnersUpdateResponseBuilder {
        <PostV1LedgerOwnersUpdateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1LedgerOwnersUpdateResponseBuilder {
    id: Option<String>,
    name: Option<String>,
    code: Option<String>,
    ...
    address: Option<PostV1LedgerOwnersUpdateResponseAddress>,
    created_at: Option<String>,
}

impl PostV1LedgerOwnersUpdateResponseBuilder {
    ...
    pub fn address(mut self, value: PostV1LedgerOwnersUpdateResponseAddress) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1LedgerOwnersUpdateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1LedgerOwnersUpdateResponseBuilder::id)
    /// - [`name`](PostV1LedgerOwnersUpdateResponseBuilder::name)
    /// - [`equity_account_code`](PostV1LedgerOwnersUpdateResponseBuilder::equity_account_code)
    /// - [`created_at`](PostV1LedgerOwnersUpdateResponseBuilder::created_at)
    pub fn build(self) -> Result<PostV1LedgerOwnersUpdateResponse, BuildError> {
        Ok(PostV1LedgerOwnersUpdateResponse {
