...
pub enum PostV1ProjectsListRequestFilterItemOp {
    Eq,
    Ne,
    Contains,
    Gte,
...
impl Serialize for PostV1ProjectsListRequestFilterItemOp {
...
impl<'de> Deserialize<'de> for PostV1ProjectsListRequestFilterItemOp {
...
impl fmt::Display for PostV1ProjectsListRequestFilterItemOp {
