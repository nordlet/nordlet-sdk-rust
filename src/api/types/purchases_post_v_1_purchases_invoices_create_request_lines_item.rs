...
pub struct PostV1PurchasesInvoicesCreateRequestLinesItem {
    #[serde(rename = "itemId")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quantity: Option<PostV1PurchasesInvoicesCreateRequestLinesItemQuantity>,
...
impl PostV1PurchasesInvoicesCreateRequestLinesItem {
    pub fn builder() -> PostV1PurchasesInvoicesCreateRequestLinesItemBuilder {
        <PostV1PurchasesInvoicesCreateRequestLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesInvoicesCreateRequestLinesItemBuilder {
    item_id: Option<String>,
    description: Option<String>,
    unit: Option<String>,
    quantity: Option<PostV1PurchasesInvoicesCreateRequestLinesItemQuantity>,
...
impl PostV1PurchasesInvoicesCreateRequestLinesItemBuilder {
    ...
    pub fn quantity(
        mut self,
        value: PostV1PurchasesInvoicesCreateRequestLinesItemQuantity,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesInvoicesCreateRequestLinesItem`].
    pub fn build(self) -> Result<PostV1PurchasesInvoicesCreateRequestLinesItem, BuildError> {
        Ok(PostV1PurchasesInvoicesCreateRequestLinesItem {
