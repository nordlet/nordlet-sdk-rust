...
pub struct PostV1SalesInvoicesGetResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
    ...
    pub recognition_method: PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod,
    ...
    pub recognition_milestones:
        Option<Vec<PostV1SalesInvoicesGetResponseLinesItemRecognitionMilestonesItem>>,
...
impl PostV1SalesInvoicesGetResponseLinesItem {
    pub fn builder() -> PostV1SalesInvoicesGetResponseLinesItemBuilder {
        <PostV1SalesInvoicesGetResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesInvoicesGetResponseLinesItemBuilder {
    id: Option<String>,
    ...
    recognition_method: Option<PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod>,
...
impl PostV1SalesInvoicesGetResponseLinesItemBuilder {
    ...
    pub fn recognition_method(
        mut self,
        value: PostV1SalesInvoicesGetResponseLinesItemRecognitionMethod,
    ) -> Self {
    ...
    pub fn recognition_milestones(
        mut self,
        value: Vec<PostV1SalesInvoicesGetResponseLinesItemRecognitionMilestonesItem>,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1SalesInvoicesGetResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1SalesInvoicesGetResponseLinesItemBuilder::id)
    /// - [`description`](PostV1SalesInvoicesGetResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1SalesInvoicesGetResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1SalesInvoicesGetResponseLinesItemBuilder::quantity)
    /// - [`vat_rate_percent`](PostV1SalesInvoicesGetResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1SalesInvoicesGetResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1SalesInvoicesGetResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1SalesInvoicesGetResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1SalesInvoicesGetResponseLinesItemBuilder::sort_order)
    /// - [`recognition_method`](PostV1SalesInvoicesGetResponseLinesItemBuilder::recognition_method)
    pub fn build(self) -> Result<PostV1SalesInvoicesGetResponseLinesItem, BuildError> {
        Ok(PostV1SalesInvoicesGetResponseLinesItem {
