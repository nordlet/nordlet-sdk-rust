...
pub enum PostV1OperationTypesCreateRequestInvoiceType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1OperationTypesCreateRequestInvoiceType {
...
impl<'de> Deserialize<'de> for PostV1OperationTypesCreateRequestInvoiceType {
...
impl fmt::Display for PostV1OperationTypesCreateRequestInvoiceType {
