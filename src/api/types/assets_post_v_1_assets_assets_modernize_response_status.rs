...
pub enum PostV1AssetsAssetsModernizeResponseStatus {
    Active,
    FullyDepreciated,
    Disposed,
...
impl Serialize for PostV1AssetsAssetsModernizeResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1AssetsAssetsModernizeResponseStatus {
...
impl fmt::Display for PostV1AssetsAssetsModernizeResponseStatus {
