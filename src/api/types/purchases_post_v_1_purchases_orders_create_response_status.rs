...
pub enum PostV1PurchasesOrdersCreateResponseStatus {
    Draft,
    Submitted,
    Approved,
    PartiallyReceived,
...
impl Serialize for PostV1PurchasesOrdersCreateResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1PurchasesOrdersCreateResponseStatus {
...
impl fmt::Display for PostV1PurchasesOrdersCreateResponseStatus {
