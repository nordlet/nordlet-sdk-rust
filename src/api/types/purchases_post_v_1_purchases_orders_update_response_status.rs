...
pub enum PostV1PurchasesOrdersUpdateResponseStatus {
    Draft,
    Submitted,
    Approved,
    PartiallyReceived,
...
impl Serialize for PostV1PurchasesOrdersUpdateResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1PurchasesOrdersUpdateResponseStatus {
...
impl fmt::Display for PostV1PurchasesOrdersUpdateResponseStatus {
