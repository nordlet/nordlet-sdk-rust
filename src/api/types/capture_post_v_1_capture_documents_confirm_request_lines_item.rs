...
pub struct PostV1CaptureDocumentsConfirmRequestLinesItem {
    #[serde(rename = "itemId")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quantity: Option<PostV1CaptureDocumentsConfirmRequestLinesItemQuantity>,
...
impl PostV1CaptureDocumentsConfirmRequestLinesItem {
    pub fn builder() -> PostV1CaptureDocumentsConfirmRequestLinesItemBuilder {
        <PostV1CaptureDocumentsConfirmRequestLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1CaptureDocumentsConfirmRequestLinesItemBuilder {
    item_id: Option<String>,
    description: Option<String>,
    unit: Option<String>,
    quantity: Option<PostV1CaptureDocumentsConfirmRequestLinesItemQuantity>,
...
impl PostV1CaptureDocumentsConfirmRequestLinesItemBuilder {
    ...
    pub fn quantity(
        mut self,
        value: PostV1CaptureDocumentsConfirmRequestLinesItemQuantity,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1CaptureDocumentsConfirmRequestLinesItem`].
    pub fn build(self) -> Result<PostV1CaptureDocumentsConfirmRequestLinesItem, BuildError> {
        Ok(PostV1CaptureDocumentsConfirmRequestLinesItem {
