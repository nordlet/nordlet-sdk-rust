...
pub struct PostV1SalesActsUpdateResponse {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "partnerId")]
    #[serde(default)]
    pub partner_id: String,
    pub r#type: PostV1SalesActsUpdateResponseType,
    pub status: PostV1SalesActsUpdateResponseStatus,
    #[serde(default)]
    pub series: String,
    ...
    #[serde(default)]
    pub lines: Vec<PostV1SalesActsUpdateResponseLinesItem>,
}

impl PostV1SalesActsUpdateResponse {
    pub fn builder() -> PostV1SalesActsUpdateResponseBuilder {
        <PostV1SalesActsUpdateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesActsUpdateResponseBuilder {
    id: Option<String>,
    partner_id: Option<String>,
    r#type: Option<PostV1SalesActsUpdateResponseType>,
    status: Option<PostV1SalesActsUpdateResponseStatus>,
    ...
    lines: Option<Vec<PostV1SalesActsUpdateResponseLinesItem>>,
}

impl PostV1SalesActsUpdateResponseBuilder {
    ...
    pub fn r#type(mut self, value: PostV1SalesActsUpdateResponseType) -> Self {
        self.r#type = Some(value);
        self
    }

    pub fn status(mut self, value: PostV1SalesActsUpdateResponseStatus) -> Self {
    ...
    pub fn lines(mut self, value: Vec<PostV1SalesActsUpdateResponseLinesItem>) -> Self {
        self.lines = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1SalesActsUpdateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1SalesActsUpdateResponseBuilder::id)
    /// - [`partner_id`](PostV1SalesActsUpdateResponseBuilder::partner_id)
    /// - [`r#type`](PostV1SalesActsUpdateResponseBuilder::r#type)
    /// - [`status`](PostV1SalesActsUpdateResponseBuilder::status)
    /// - [`series`](PostV1SalesActsUpdateResponseBuilder::series)
    /// - [`document_date`](PostV1SalesActsUpdateResponseBuilder::document_date)
    /// - [`created_at`](PostV1SalesActsUpdateResponseBuilder::created_at)
    /// - [`updated_at`](PostV1SalesActsUpdateResponseBuilder::updated_at)
    /// - [`lines`](PostV1SalesActsUpdateResponseBuilder::lines)
    pub fn build(self) -> Result<PostV1SalesActsUpdateResponse, BuildError> {
        Ok(PostV1SalesActsUpdateResponse {
