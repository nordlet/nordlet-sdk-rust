...
pub struct PostV1TransportWaybillsGetResponse {
    #[serde(default)]
    pub id: String,
    pub status: PostV1TransportWaybillsGetResponseStatus,
    #[serde(default)]
    pub series: String,
    ...
    #[serde(default)]
    pub lines: Vec<PostV1TransportWaybillsGetResponseLinesItem>,
}

impl PostV1TransportWaybillsGetResponse {
    pub fn builder() -> PostV1TransportWaybillsGetResponseBuilder {
        <PostV1TransportWaybillsGetResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1TransportWaybillsGetResponseBuilder {
    id: Option<String>,
    status: Option<PostV1TransportWaybillsGetResponseStatus>,
    ...
    lines: Option<Vec<PostV1TransportWaybillsGetResponseLinesItem>>,
}

impl PostV1TransportWaybillsGetResponseBuilder {
    pub fn id(mut self, value: impl Into<String>) -> Self {
        self.id = Some(value.into());
        self
    }

    pub fn status(mut self, value: PostV1TransportWaybillsGetResponseStatus) -> Self {
    ...
    pub fn lines(mut self, value: Vec<PostV1TransportWaybillsGetResponseLinesItem>) -> Self {
        self.lines = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1TransportWaybillsGetResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1TransportWaybillsGetResponseBuilder::id)
    /// - [`status`](PostV1TransportWaybillsGetResponseBuilder::status)
    /// - [`series`](PostV1TransportWaybillsGetResponseBuilder::series)
    /// - [`document_date`](PostV1TransportWaybillsGetResponseBuilder::document_date)
    /// - [`dispatch_at`](PostV1TransportWaybillsGetResponseBuilder::dispatch_at)
    /// - [`consignee_partner_id`](PostV1TransportWaybillsGetResponseBuilder::consignee_partner_id)
    /// - [`load_address`](PostV1TransportWaybillsGetResponseBuilder::load_address)
    /// - [`unload_address`](PostV1TransportWaybillsGetResponseBuilder::unload_address)
    /// - [`created_at`](PostV1TransportWaybillsGetResponseBuilder::created_at)
    /// - [`updated_at`](PostV1TransportWaybillsGetResponseBuilder::updated_at)
    /// - [`lines`](PostV1TransportWaybillsGetResponseBuilder::lines)
    pub fn build(self) -> Result<PostV1TransportWaybillsGetResponse, BuildError> {
        Ok(PostV1TransportWaybillsGetResponse {
