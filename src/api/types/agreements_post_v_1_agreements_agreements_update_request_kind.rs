...
pub enum PostV1AgreementsAgreementsUpdateRequestKind {
    Customer,
    Supplier,
    Employment,
    Bank,
...
impl Serialize for PostV1AgreementsAgreementsUpdateRequestKind {
...
impl<'de> Deserialize<'de> for PostV1AgreementsAgreementsUpdateRequestKind {
...
impl fmt::Display for PostV1AgreementsAgreementsUpdateRequestKind {
