...
pub struct PostV1AssetsGroupsListResponseRowsItem {
    #[serde(default)]
    pub code: String,
    #[serde(default)]
    pub name: String,
...
impl PostV1AssetsGroupsListResponseRowsItem {
    pub fn builder() -> PostV1AssetsGroupsListResponseRowsItemBuilder {
        <PostV1AssetsGroupsListResponseRowsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1AssetsGroupsListResponseRowsItemBuilder {
    code: Option<String>,
    name: Option<String>,
...
impl PostV1AssetsGroupsListResponseRowsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1AssetsGroupsListResponseRowsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`code`](PostV1AssetsGroupsListResponseRowsItemBuilder::code)
    /// - [`name`](PostV1AssetsGroupsListResponseRowsItemBuilder::name)
    /// - [`asset_account_code`](PostV1AssetsGroupsListResponseRowsItemBuilder::asset_account_code)
    /// - [`depreciation_account_code`](PostV1AssetsGroupsListResponseRowsItemBuilder::depreciation_account_code)
    /// - [`expense_account_code`](PostV1AssetsGroupsListResponseRowsItemBuilder::expense_account_code)
    /// - [`id`](PostV1AssetsGroupsListResponseRowsItemBuilder::id)
    /// - [`created_at`](PostV1AssetsGroupsListResponseRowsItemBuilder::created_at)
    pub fn build(self) -> Result<PostV1AssetsGroupsListResponseRowsItem, BuildError> {
        Ok(PostV1AssetsGroupsListResponseRowsItem {
