...
pub struct PostV1PurchasesOrdersCloseResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1PurchasesOrdersCloseResponseLinesItem {
    pub fn builder() -> PostV1PurchasesOrdersCloseResponseLinesItemBuilder {
        <PostV1PurchasesOrdersCloseResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesOrdersCloseResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1PurchasesOrdersCloseResponseLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesOrdersCloseResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::id)
    /// - [`description`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::quantity)
    /// - [`received_qty`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::received_qty)
    /// - [`remaining_qty`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::remaining_qty)
    /// - [`vat_rate_percent`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1PurchasesOrdersCloseResponseLinesItemBuilder::sort_order)
    pub fn build(self) -> Result<PostV1PurchasesOrdersCloseResponseLinesItem, BuildError> {
        Ok(PostV1PurchasesOrdersCloseResponseLinesItem {
