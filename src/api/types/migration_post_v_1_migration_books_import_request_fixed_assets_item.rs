...
pub struct PostV1MigrationBooksImportRequestFixedAssetsItem {
...
impl PostV1MigrationBooksImportRequestFixedAssetsItem {
    pub fn builder() -> PostV1MigrationBooksImportRequestFixedAssetsItemBuilder {
        <PostV1MigrationBooksImportRequestFixedAssetsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1MigrationBooksImportRequestFixedAssetsItemBuilder {
...
impl PostV1MigrationBooksImportRequestFixedAssetsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1MigrationBooksImportRequestFixedAssetsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`group_code`](PostV1MigrationBooksImportRequestFixedAssetsItemBuilder::group_code)
    /// - [`code`](PostV1MigrationBooksImportRequestFixedAssetsItemBuilder::code)
    /// - [`name`](PostV1MigrationBooksImportRequestFixedAssetsItemBuilder::name)
    /// - [`acquisition_date`](PostV1MigrationBooksImportRequestFixedAssetsItemBuilder::acquisition_date)
    /// - [`acquisition_cost`](PostV1MigrationBooksImportRequestFixedAssetsItemBuilder::acquisition_cost)
    pub fn build(self) -> Result<PostV1MigrationBooksImportRequestFixedAssetsItem, BuildError> {
        Ok(PostV1MigrationBooksImportRequestFixedAssetsItem {
            group_code: self
                .group_code
