...
pub struct PostV1TransportWaybillsUpdateResponse {
    #[serde(default)]
    pub id: String,
    pub status: PostV1TransportWaybillsUpdateResponseStatus,
    #[serde(default)]
    pub series: String,
    ...
    #[serde(default)]
    pub lines: Vec<PostV1TransportWaybillsUpdateResponseLinesItem>,
}

impl PostV1TransportWaybillsUpdateResponse {
    pub fn builder() -> PostV1TransportWaybillsUpdateResponseBuilder {
        <PostV1TransportWaybillsUpdateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1TransportWaybillsUpdateResponseBuilder {
    id: Option<String>,
    status: Option<PostV1TransportWaybillsUpdateResponseStatus>,
    ...
    lines: Option<Vec<PostV1TransportWaybillsUpdateResponseLinesItem>>,
}

impl PostV1TransportWaybillsUpdateResponseBuilder {
    pub fn id(mut self, value: impl Into<String>) -> Self {
        self.id = Some(value.into());
        self
    }

    pub fn status(mut self, value: PostV1TransportWaybillsUpdateResponseStatus) -> Self {
    ...
    pub fn lines(mut self, value: Vec<PostV1TransportWaybillsUpdateResponseLinesItem>) -> Self {
        self.lines = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1TransportWaybillsUpdateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1TransportWaybillsUpdateResponseBuilder::id)
    /// - [`status`](PostV1TransportWaybillsUpdateResponseBuilder::status)
    /// - [`series`](PostV1TransportWaybillsUpdateResponseBuilder::series)
    /// - [`document_date`](PostV1TransportWaybillsUpdateResponseBuilder::document_date)
    /// - [`dispatch_at`](PostV1TransportWaybillsUpdateResponseBuilder::dispatch_at)
    /// - [`consignee_partner_id`](PostV1TransportWaybillsUpdateResponseBuilder::consignee_partner_id)
    /// - [`load_address`](PostV1TransportWaybillsUpdateResponseBuilder::load_address)
    /// - [`unload_address`](PostV1TransportWaybillsUpdateResponseBuilder::unload_address)
    /// - [`created_at`](PostV1TransportWaybillsUpdateResponseBuilder::created_at)
    /// - [`updated_at`](PostV1TransportWaybillsUpdateResponseBuilder::updated_at)
    /// - [`lines`](PostV1TransportWaybillsUpdateResponseBuilder::lines)
    pub fn build(self) -> Result<PostV1TransportWaybillsUpdateResponse, BuildError> {
        Ok(PostV1TransportWaybillsUpdateResponse {
