...
pub struct PostV1CatalogItemsCreateResponse {
    #[serde(default)]
    pub id: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub translations:
        Option<HashMap<String, Option<PostV1CatalogItemsCreateResponseTranslationsValue>>>,
    #[serde(default)]
    pub components: Vec<PostV1CatalogItemsCreateResponseComponentsItem>,
    #[serde(rename = "kindId")]
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl PostV1CatalogItemsCreateResponse {
    pub fn builder() -> PostV1CatalogItemsCreateResponseBuilder {
        <PostV1CatalogItemsCreateResponseBuilder as Default>::default()
    }
}
...
pub struct PostV1CatalogItemsCreateResponseBuilder {
    ...
    translations:
        Option<HashMap<String, Option<PostV1CatalogItemsCreateResponseTranslationsValue>>>,
    components: Option<Vec<PostV1CatalogItemsCreateResponseComponentsItem>>,
...
impl PostV1CatalogItemsCreateResponseBuilder {
    ...
    pub fn translations(
        mut self,
        value: HashMap<String, Option<PostV1CatalogItemsCreateResponseTranslationsValue>>,
    ) -> Self {
    ...
    pub fn components(
        mut self,
        value: Vec<PostV1CatalogItemsCreateResponseComponentsItem>,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1CatalogItemsCreateResponse`].
    ...
    /// - [`is_free_price`](PostV1CatalogItemsCreateResponseBuilder::is_free_price)
    /// - [`is_returnable`](PostV1CatalogItemsCreateResponseBuilder::is_returnable)
    /// - [`comment_required`](PostV1CatalogItemsCreateResponseBuilder::comment_required)
    /// - [`created_at`](PostV1CatalogItemsCreateResponseBuilder::created_at)
    /// - [`updated_at`](PostV1CatalogItemsCreateResponseBuilder::updated_at)
    pub fn build(self) -> Result<PostV1CatalogItemsCreateResponse, BuildError> {
        Ok(PostV1CatalogItemsCreateResponse {
