...
pub struct PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItem {
    #[serde(default)]
...
impl PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItem {
    pub fn builder() -> PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItemBuilder {
        <PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItemBuilder as Default>::default(
        )
    }
}
...
#[non_exhaustive]
pub struct PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItemBuilder {
...
impl PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`description`](PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItemBuilder::description)
    /// - [`quantity`](PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItemBuilder::quantity)
    pub fn build(
        self,
    ) -> Result<PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItem, BuildError> {
        Ok(
