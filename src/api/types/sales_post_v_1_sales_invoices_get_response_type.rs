...
pub enum PostV1SalesInvoicesGetResponseType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1SalesInvoicesGetResponseType {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesGetResponseType {
...
impl fmt::Display for PostV1SalesInvoicesGetResponseType {
