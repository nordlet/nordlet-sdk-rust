...
pub enum PostV1PurchasesOrdersRejectResponseStatus {
    Draft,
    Submitted,
    Approved,
    PartiallyReceived,
...
impl Serialize for PostV1PurchasesOrdersRejectResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1PurchasesOrdersRejectResponseStatus {
...
impl fmt::Display for PostV1PurchasesOrdersRejectResponseStatus {
