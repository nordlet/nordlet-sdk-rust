...
pub enum PostV1ReferenceEuVatRatesListResponseRowsItemCategory {
    Standard,
    Reduced,
    SuperReduced,
    Parking,
...
impl Serialize for PostV1ReferenceEuVatRatesListResponseRowsItemCategory {
...
impl<'de> Deserialize<'de> for PostV1ReferenceEuVatRatesListResponseRowsItemCategory {
...
impl fmt::Display for PostV1ReferenceEuVatRatesListResponseRowsItemCategory {
