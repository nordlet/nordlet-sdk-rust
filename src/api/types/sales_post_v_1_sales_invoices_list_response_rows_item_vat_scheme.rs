...
pub enum PostV1SalesInvoicesListResponseRowsItemVatScheme {
    Domestic,
    IntraEuB2B,
    ReverseCharge,
    OssUnion,
...
impl Serialize for PostV1SalesInvoicesListResponseRowsItemVatScheme {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesListResponseRowsItemVatScheme {
...
impl fmt::Display for PostV1SalesInvoicesListResponseRowsItemVatScheme {
