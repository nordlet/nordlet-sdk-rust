...
pub enum PostV1BankTransactionsRecordRequestDocumentType {
    SaleInvoice,
    PurchaseInvoice,
...
impl Serialize for PostV1BankTransactionsRecordRequestDocumentType {
...
impl<'de> Deserialize<'de> for PostV1BankTransactionsRecordRequestDocumentType {
...
impl fmt::Display for PostV1BankTransactionsRecordRequestDocumentType {
