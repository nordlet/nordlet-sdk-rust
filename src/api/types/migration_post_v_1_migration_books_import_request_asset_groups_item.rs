...
pub struct PostV1MigrationBooksImportRequestAssetGroupsItem {
    #[serde(default)]
    pub code: String,
    #[serde(default)]
    pub name: String,
...
impl PostV1MigrationBooksImportRequestAssetGroupsItem {
    pub fn builder() -> PostV1MigrationBooksImportRequestAssetGroupsItemBuilder {
        <PostV1MigrationBooksImportRequestAssetGroupsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1MigrationBooksImportRequestAssetGroupsItemBuilder {
    code: Option<String>,
    name: Option<String>,
...
impl PostV1MigrationBooksImportRequestAssetGroupsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1MigrationBooksImportRequestAssetGroupsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`code`](PostV1MigrationBooksImportRequestAssetGroupsItemBuilder::code)
    /// - [`name`](PostV1MigrationBooksImportRequestAssetGroupsItemBuilder::name)
    /// - [`asset_account_code`](PostV1MigrationBooksImportRequestAssetGroupsItemBuilder::asset_account_code)
    /// - [`depreciation_account_code`](PostV1MigrationBooksImportRequestAssetGroupsItemBuilder::depreciation_account_code)
    pub fn build(self) -> Result<PostV1MigrationBooksImportRequestAssetGroupsItem, BuildError> {
        Ok(PostV1MigrationBooksImportRequestAssetGroupsItem {
