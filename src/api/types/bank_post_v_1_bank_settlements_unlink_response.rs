...
pub struct PostV1BankSettlementsUnlinkResponse {
    #[serde(default)]
    pub id: String,
    ...
    pub status: PostV1BankSettlementsUnlinkResponseStatus,
...
impl PostV1BankSettlementsUnlinkResponse {
    pub fn builder() -> PostV1BankSettlementsUnlinkResponseBuilder {
        <PostV1BankSettlementsUnlinkResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1BankSettlementsUnlinkResponseBuilder {
    id: Option<String>,
    ...
    status: Option<PostV1BankSettlementsUnlinkResponseStatus>,
...
impl PostV1BankSettlementsUnlinkResponseBuilder {
    ...
    pub fn status(mut self, value: PostV1BankSettlementsUnlinkResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1BankSettlementsUnlinkResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1BankSettlementsUnlinkResponseBuilder::id)
    /// - [`bank_account_id`](PostV1BankSettlementsUnlinkResponseBuilder::bank_account_id)
    /// - [`provider`](PostV1BankSettlementsUnlinkResponseBuilder::provider)
    /// - [`payout_id`](PostV1BankSettlementsUnlinkResponseBuilder::payout_id)
    /// - [`currency`](PostV1BankSettlementsUnlinkResponseBuilder::currency)
    /// - [`gross_total`](PostV1BankSettlementsUnlinkResponseBuilder::gross_total)
    /// - [`fee_total`](PostV1BankSettlementsUnlinkResponseBuilder::fee_total)
    /// - [`net_total`](PostV1BankSettlementsUnlinkResponseBuilder::net_total)
    /// - [`status`](PostV1BankSettlementsUnlinkResponseBuilder::status)
    /// - [`line_count`](PostV1BankSettlementsUnlinkResponseBuilder::line_count)
    /// - [`matched_count`](PostV1BankSettlementsUnlinkResponseBuilder::matched_count)
    /// - [`unmatched_count`](PostV1BankSettlementsUnlinkResponseBuilder::unmatched_count)
    /// - [`created_at`](PostV1BankSettlementsUnlinkResponseBuilder::created_at)
    /// - [`updated_at`](PostV1BankSettlementsUnlinkResponseBuilder::updated_at)
    pub fn build(self) -> Result<PostV1BankSettlementsUnlinkResponse, BuildError> {
        Ok(PostV1BankSettlementsUnlinkResponse {
