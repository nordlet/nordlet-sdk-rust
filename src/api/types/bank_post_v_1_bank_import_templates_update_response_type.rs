...
pub enum PostV1BankImportTemplatesUpdateResponseType {
    Stripe,
    Iso20022,
    BankConnection,
...
impl Serialize for PostV1BankImportTemplatesUpdateResponseType {
...
impl<'de> Deserialize<'de> for PostV1BankImportTemplatesUpdateResponseType {
...
impl fmt::Display for PostV1BankImportTemplatesUpdateResponseType {
