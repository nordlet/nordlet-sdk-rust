...
pub enum PostV1HrEmployeesRecordsCreateResponseType {
    Education,
    Qualification,
    Certificate,
    Training,
...
impl Serialize for PostV1HrEmployeesRecordsCreateResponseType {
...
impl<'de> Deserialize<'de> for PostV1HrEmployeesRecordsCreateResponseType {
...
impl fmt::Display for PostV1HrEmployeesRecordsCreateResponseType {
