...
pub enum PostV1SalesInvoicesUnlockResponseLinesItemRecognitionMethod {
    PointInTime,
    Ratable,
    Milestone,
    PercentComplete,
...
impl Serialize for PostV1SalesInvoicesUnlockResponseLinesItemRecognitionMethod {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesUnlockResponseLinesItemRecognitionMethod {
...
impl fmt::Display for PostV1SalesInvoicesUnlockResponseLinesItemRecognitionMethod {
