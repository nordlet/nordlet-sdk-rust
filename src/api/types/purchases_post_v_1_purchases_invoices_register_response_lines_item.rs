...
pub struct PostV1PurchasesInvoicesRegisterResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1PurchasesInvoicesRegisterResponseLinesItem {
    pub fn builder() -> PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder {
        <PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesInvoicesRegisterResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder::id)
    /// - [`description`](PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder::quantity)
    /// - [`vat_rate_percent`](PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1PurchasesInvoicesRegisterResponseLinesItemBuilder::sort_order)
    pub fn build(self) -> Result<PostV1PurchasesInvoicesRegisterResponseLinesItem, BuildError> {
        Ok(PostV1PurchasesInvoicesRegisterResponseLinesItem {
