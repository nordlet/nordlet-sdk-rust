...
pub enum PostV1SalesInvoicesApplyAdvanceResponseVatScheme {
    Domestic,
    IntraEuB2B,
    ReverseCharge,
    OssUnion,
...
impl Serialize for PostV1SalesInvoicesApplyAdvanceResponseVatScheme {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesApplyAdvanceResponseVatScheme {
...
impl fmt::Display for PostV1SalesInvoicesApplyAdvanceResponseVatScheme {
