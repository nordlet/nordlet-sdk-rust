...
pub struct PostV1OperationTypesUpdateResponse {
    #[serde(default)]
    pub id: String,
    #[serde(default)]
    pub code: String,
    ...
    pub invoice_type: Option<PostV1OperationTypesUpdateResponseInvoiceType>,
...
impl PostV1OperationTypesUpdateResponse {
    pub fn builder() -> PostV1OperationTypesUpdateResponseBuilder {
        <PostV1OperationTypesUpdateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1OperationTypesUpdateResponseBuilder {
    id: Option<String>,
    code: Option<String>,
    name: Option<String>,
    invoice_type: Option<PostV1OperationTypesUpdateResponseInvoiceType>,
...
impl PostV1OperationTypesUpdateResponseBuilder {
    ...
    pub fn invoice_type(mut self, value: PostV1OperationTypesUpdateResponseInvoiceType) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1OperationTypesUpdateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1OperationTypesUpdateResponseBuilder::id)
    /// - [`code`](PostV1OperationTypesUpdateResponseBuilder::code)
    /// - [`name`](PostV1OperationTypesUpdateResponseBuilder::name)
    /// - [`is_purchase`](PostV1OperationTypesUpdateResponseBuilder::is_purchase)
    /// - [`is_sale`](PostV1OperationTypesUpdateResponseBuilder::is_sale)
    /// - [`is_write_off`](PostV1OperationTypesUpdateResponseBuilder::is_write_off)
    /// - [`is_internal_movement`](PostV1OperationTypesUpdateResponseBuilder::is_internal_movement)
    /// - [`is_purchase_return`](PostV1OperationTypesUpdateResponseBuilder::is_purchase_return)
    /// - [`is_sales_return`](PostV1OperationTypesUpdateResponseBuilder::is_sales_return)
    /// - [`is_consignment`](PostV1OperationTypesUpdateResponseBuilder::is_consignment)
    /// - [`is_production`](PostV1OperationTypesUpdateResponseBuilder::is_production)
    /// - [`is_asset_in`](PostV1OperationTypesUpdateResponseBuilder::is_asset_in)
    /// - [`is_asset_out`](PostV1OperationTypesUpdateResponseBuilder::is_asset_out)
    /// - [`is_cash_register_sale`](PostV1OperationTypesUpdateResponseBuilder::is_cash_register_sale)
    /// - [`include_in_vat_register`](PostV1OperationTypesUpdateResponseBuilder::include_in_vat_register)
    /// - [`include_in_saft`](PostV1OperationTypesUpdateResponseBuilder::include_in_saft)
    /// - [`is_active`](PostV1OperationTypesUpdateResponseBuilder::is_active)
    /// - [`sort_order`](PostV1OperationTypesUpdateResponseBuilder::sort_order)
    /// - [`created_at`](PostV1OperationTypesUpdateResponseBuilder::created_at)
    /// - [`updated_at`](PostV1OperationTypesUpdateResponseBuilder::updated_at)
    pub fn build(self) -> Result<PostV1OperationTypesUpdateResponse, BuildError> {
        Ok(PostV1OperationTypesUpdateResponse {
