...
pub enum PostV1HrEmployeesRecordsListResponseRowsItemType {
    Education,
    Qualification,
    Certificate,
    Training,
...
impl Serialize for PostV1HrEmployeesRecordsListResponseRowsItemType {
...
impl<'de> Deserialize<'de> for PostV1HrEmployeesRecordsListResponseRowsItemType {
...
impl fmt::Display for PostV1HrEmployeesRecordsListResponseRowsItemType {
