...
pub struct PostV1MigrationBooksValidateRequestOpenReceivablesItem {
...
impl PostV1MigrationBooksValidateRequestOpenReceivablesItem {
    pub fn builder() -> PostV1MigrationBooksValidateRequestOpenReceivablesItemBuilder {
        <PostV1MigrationBooksValidateRequestOpenReceivablesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1MigrationBooksValidateRequestOpenReceivablesItemBuilder {
...
impl PostV1MigrationBooksValidateRequestOpenReceivablesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1MigrationBooksValidateRequestOpenReceivablesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`partner_code`](PostV1MigrationBooksValidateRequestOpenReceivablesItemBuilder::partner_code)
    /// - [`gross_total`](PostV1MigrationBooksValidateRequestOpenReceivablesItemBuilder::gross_total)
    /// - [`number`](PostV1MigrationBooksValidateRequestOpenReceivablesItemBuilder::number)
    /// - [`issue_date`](PostV1MigrationBooksValidateRequestOpenReceivablesItemBuilder::issue_date)
    pub fn build(
        self,
    ) -> Result<PostV1MigrationBooksValidateRequestOpenReceivablesItem, BuildError> {
        Ok(PostV1MigrationBooksValidateRequestOpenReceivablesItem {
            partner_code: self
                .partner_code
