...
impl PostV1SalesInvoicesUpdateResponseLinesItem {
    pub fn builder() -> PostV1SalesInvoicesUpdateResponseLinesItemBuilder {
        <PostV1SalesInvoicesUpdateResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesInvoicesUpdateResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1SalesInvoicesUpdateResponseLinesItemBuilder {
    ...
    /// - [`description`](PostV1SalesInvoicesUpdateResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1SalesInvoicesUpdateResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1SalesInvoicesUpdateResponseLinesItemBuilder::quantity)
    /// - [`vat_rate_percent`](PostV1SalesInvoicesUpdateResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1SalesInvoicesUpdateResponseLinesItemBuilder::line_net)
