...
pub enum PostV1AgreementsAgreementsCreateRequestKind {
    Customer,
    Supplier,
    Employment,
    Bank,
...
impl Serialize for PostV1AgreementsAgreementsCreateRequestKind {
...
impl<'de> Deserialize<'de> for PostV1AgreementsAgreementsCreateRequestKind {
...
impl fmt::Display for PostV1AgreementsAgreementsCreateRequestKind {
