...
pub enum PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod {
    PointInTime,
    Ratable,
    Milestone,
    PercentComplete,
...
impl Serialize for PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod {
...
impl fmt::Display for PostV1SalesInvoicesLockResponseLinesItemRecognitionMethod {
