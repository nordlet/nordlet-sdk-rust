...
pub struct PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem {
    pub fn builder() -> PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder {
        <PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder {
    id: Option<String>,
...
impl PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder::id)
    /// - [`description`](PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder::description)
    /// - [`unit`](PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder::unit)
    /// - [`quantity`](PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder::quantity)
    /// - [`vat_rate_percent`](PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1CaptureDocumentsConfirmResponseInvoiceLinesItemBuilder::sort_order)
    pub fn build(
        self,
    ) -> Result<PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem, BuildError> {
        Ok(PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem {
