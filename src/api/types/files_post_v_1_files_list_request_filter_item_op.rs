...
pub enum PostV1FilesListRequestFilterItemOp {
    Eq,
    Ne,
    Contains,
    Gte,
...
impl Serialize for PostV1FilesListRequestFilterItemOp {
...
impl<'de> Deserialize<'de> for PostV1FilesListRequestFilterItemOp {
...
impl fmt::Display for PostV1FilesListRequestFilterItemOp {
