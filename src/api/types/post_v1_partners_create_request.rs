...
pub struct PostV1PartnersCreateRequest {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub r#type: Option<PostV1PartnersCreateRequestType>,
    #[serde(default)]
    pub name: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub correspondence_address: Option<PostV1PartnersCreateRequestCorrespondenceAddress>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub legal_country_class: Option<PostV1PartnersCreateRequestLegalCountryClass>,
}

impl PostV1PartnersCreateRequest {
    pub fn builder() -> PostV1PartnersCreateRequestBuilder {
        <PostV1PartnersCreateRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PartnersCreateRequestBuilder {
    r#type: Option<PostV1PartnersCreateRequestType>,
    name: Option<String>,
    code: Option<String>,
...
impl PostV1PartnersCreateRequestBuilder {
    pub fn r#type(mut self, value: PostV1PartnersCreateRequestType) -> Self {
    ...
    pub fn address(mut self, value: PostV1PartnersCreateRequestAddress) -> Self {
    ...
    pub fn correspondence_address(
        mut self,
        value: PostV1PartnersCreateRequestCorrespondenceAddress,
    ) -> Self {
    ...
    pub fn legal_country_class(
        mut self,
        value: PostV1PartnersCreateRequestLegalCountryClass,
    ) -> Self {
    ...
    pub fn build(self) -> Result<PostV1PartnersCreateRequest, BuildError> {
        Ok(PostV1PartnersCreateRequest {
            r#type: self.r#type,
