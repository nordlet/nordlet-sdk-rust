...
pub struct PostV1FilesUploadResponse {
    #[serde(default)]
    pub id: String,
    #[serde(default)]
    pub entity: String,
...
impl PostV1FilesUploadResponse {
    pub fn builder() -> PostV1FilesUploadResponseBuilder {
        <PostV1FilesUploadResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1FilesUploadResponseBuilder {
    id: Option<String>,
...
impl PostV1FilesUploadResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1FilesUploadResponse`].
