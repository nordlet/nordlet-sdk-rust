...
pub struct PostV1OperationTypesCreateRequest {
    #[serde(default)]
    pub code: String,
    #[serde(default)]
    pub name: String,
    ...
    pub invoice_type: Option<PostV1OperationTypesCreateRequestInvoiceType>,
...
impl PostV1OperationTypesCreateRequest {
    pub fn builder() -> PostV1OperationTypesCreateRequestBuilder {
        <PostV1OperationTypesCreateRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1OperationTypesCreateRequestBuilder {
    code: Option<String>,
    name: Option<String>,
    invoice_type: Option<PostV1OperationTypesCreateRequestInvoiceType>,
...
impl PostV1OperationTypesCreateRequestBuilder {
    ...
    pub fn invoice_type(mut self, value: PostV1OperationTypesCreateRequestInvoiceType) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1OperationTypesCreateRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`code`](PostV1OperationTypesCreateRequestBuilder::code)
    /// - [`name`](PostV1OperationTypesCreateRequestBuilder::name)
    pub fn build(self) -> Result<PostV1OperationTypesCreateRequest, BuildError> {
        Ok(PostV1OperationTypesCreateRequest {
