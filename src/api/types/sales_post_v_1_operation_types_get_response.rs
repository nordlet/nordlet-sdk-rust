...
pub struct PostV1OperationTypesGetResponse {
    #[serde(default)]
    pub id: String,
    #[serde(default)]
    pub code: String,
    ...
    pub invoice_type: Option<PostV1OperationTypesGetResponseInvoiceType>,
...
impl PostV1OperationTypesGetResponse {
    pub fn builder() -> PostV1OperationTypesGetResponseBuilder {
        <PostV1OperationTypesGetResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1OperationTypesGetResponseBuilder {
    id: Option<String>,
    code: Option<String>,
    name: Option<String>,
    invoice_type: Option<PostV1OperationTypesGetResponseInvoiceType>,
...
impl PostV1OperationTypesGetResponseBuilder {
    ...
    pub fn invoice_type(mut self, value: PostV1OperationTypesGetResponseInvoiceType) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1OperationTypesGetResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1OperationTypesGetResponseBuilder::id)
    /// - [`code`](PostV1OperationTypesGetResponseBuilder::code)
    /// - [`name`](PostV1OperationTypesGetResponseBuilder::name)
    /// - [`is_purchase`](PostV1OperationTypesGetResponseBuilder::is_purchase)
    /// - [`is_sale`](PostV1OperationTypesGetResponseBuilder::is_sale)
    /// - [`is_write_off`](PostV1OperationTypesGetResponseBuilder::is_write_off)
    /// - [`is_internal_movement`](PostV1OperationTypesGetResponseBuilder::is_internal_movement)
    /// - [`is_purchase_return`](PostV1OperationTypesGetResponseBuilder::is_purchase_return)
    /// - [`is_sales_return`](PostV1OperationTypesGetResponseBuilder::is_sales_return)
    /// - [`is_consignment`](PostV1OperationTypesGetResponseBuilder::is_consignment)
    /// - [`is_production`](PostV1OperationTypesGetResponseBuilder::is_production)
    /// - [`is_asset_in`](PostV1OperationTypesGetResponseBuilder::is_asset_in)
    /// - [`is_asset_out`](PostV1OperationTypesGetResponseBuilder::is_asset_out)
    /// - [`is_cash_register_sale`](PostV1OperationTypesGetResponseBuilder::is_cash_register_sale)
    /// - [`include_in_vat_register`](PostV1OperationTypesGetResponseBuilder::include_in_vat_register)
    /// - [`include_in_saft`](PostV1OperationTypesGetResponseBuilder::include_in_saft)
    /// - [`is_active`](PostV1OperationTypesGetResponseBuilder::is_active)
    /// - [`sort_order`](PostV1OperationTypesGetResponseBuilder::sort_order)
    /// - [`created_at`](PostV1OperationTypesGetResponseBuilder::created_at)
    /// - [`updated_at`](PostV1OperationTypesGetResponseBuilder::updated_at)
    pub fn build(self) -> Result<PostV1OperationTypesGetResponse, BuildError> {
        Ok(PostV1OperationTypesGetResponse {
