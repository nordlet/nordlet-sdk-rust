...
pub struct PostV1AgreementsAgreementsCreateResponse {
    ...
    pub kind: PostV1AgreementsAgreementsCreateResponseKind,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_period: Option<PostV1AgreementsAgreementsCreateResponseBillingPeriod>,
    #[serde(default)]
    pub currency: String,
...
pub struct PostV1AgreementsAgreementsCreateResponseBuilder {
    ...
    kind: Option<PostV1AgreementsAgreementsCreateResponseKind>,
    ...
    value: Option<String>,
    billing_period: Option<PostV1AgreementsAgreementsCreateResponseBillingPeriod>,
...
impl PostV1AgreementsAgreementsCreateResponseBuilder {
    ...
    pub fn kind(mut self, value: PostV1AgreementsAgreementsCreateResponseKind) -> Self {
    ...
    pub fn billing_period(
        mut self,
        value: PostV1AgreementsAgreementsCreateResponseBillingPeriod,
    ) -> Self {
    ...
    /// - [`kind`](PostV1AgreementsAgreementsCreateResponseBuilder::kind)
