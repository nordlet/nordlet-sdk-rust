...
pub struct PostV1PurchasesOrdersCreateRequestLinesItem {
    #[serde(rename = "itemId")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quantity: Option<PostV1PurchasesOrdersCreateRequestLinesItemQuantity>,
...
impl PostV1PurchasesOrdersCreateRequestLinesItem {
    pub fn builder() -> PostV1PurchasesOrdersCreateRequestLinesItemBuilder {
        <PostV1PurchasesOrdersCreateRequestLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesOrdersCreateRequestLinesItemBuilder {
    item_id: Option<String>,
    description: Option<String>,
    unit: Option<String>,
    quantity: Option<PostV1PurchasesOrdersCreateRequestLinesItemQuantity>,
...
impl PostV1PurchasesOrdersCreateRequestLinesItemBuilder {
    ...
    pub fn quantity(mut self, value: PostV1PurchasesOrdersCreateRequestLinesItemQuantity) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesOrdersCreateRequestLinesItem`].
    pub fn build(self) -> Result<PostV1PurchasesOrdersCreateRequestLinesItem, BuildError> {
        Ok(PostV1PurchasesOrdersCreateRequestLinesItem {
