...
pub enum PostV1HrTimesheetsUpsertResponseDaysItemType {
    Work,
    BusinessTrip,
    Vacation,
    Sick,
...
impl Serialize for PostV1HrTimesheetsUpsertResponseDaysItemType {
...
impl<'de> Deserialize<'de> for PostV1HrTimesheetsUpsertResponseDaysItemType {
...
impl fmt::Display for PostV1HrTimesheetsUpsertResponseDaysItemType {
