...
pub enum PostV1AccountInvitesCreateRequestRole {
    Admin,
    Accountant,
    Manager,
    Developer,
...
impl Serialize for PostV1AccountInvitesCreateRequestRole {
...
impl<'de> Deserialize<'de> for PostV1AccountInvitesCreateRequestRole {
...
impl fmt::Display for PostV1AccountInvitesCreateRequestRole {
