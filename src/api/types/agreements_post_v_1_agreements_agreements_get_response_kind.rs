...
pub enum PostV1AgreementsAgreementsGetResponseKind {
    Customer,
    Supplier,
    Employment,
    Bank,
...
impl Serialize for PostV1AgreementsAgreementsGetResponseKind {
...
impl<'de> Deserialize<'de> for PostV1AgreementsAgreementsGetResponseKind {
...
impl fmt::Display for PostV1AgreementsAgreementsGetResponseKind {
