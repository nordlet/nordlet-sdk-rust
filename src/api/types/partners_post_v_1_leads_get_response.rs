...
pub struct PostV1LeadsGetResponse {
    #[serde(default)]
    pub id: String,
    #[serde(default)]
    pub name: String,
    ...
    pub status: PostV1LeadsGetResponseStatus,
...
impl PostV1LeadsGetResponse {
    pub fn builder() -> PostV1LeadsGetResponseBuilder {
        <PostV1LeadsGetResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1LeadsGetResponseBuilder {
    id: Option<String>,
    name: Option<String>,
    ...
    status: Option<PostV1LeadsGetResponseStatus>,
...
impl PostV1LeadsGetResponseBuilder {
    ...
    pub fn status(mut self, value: PostV1LeadsGetResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1LeadsGetResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1LeadsGetResponseBuilder::id)
    /// - [`name`](PostV1LeadsGetResponseBuilder::name)
    /// - [`status`](PostV1LeadsGetResponseBuilder::status)
    /// - [`currency`](PostV1LeadsGetResponseBuilder::currency)
    /// - [`created_at`](PostV1LeadsGetResponseBuilder::created_at)
    /// - [`updated_at`](PostV1LeadsGetResponseBuilder::updated_at)
    pub fn build(self) -> Result<PostV1LeadsGetResponse, BuildError> {
        Ok(PostV1LeadsGetResponse {
