...
pub enum PostV1LeadsUpdateResponseStatus {
    New,
    Contacted,
    Qualified,
    Lost,
...
impl Serialize for PostV1LeadsUpdateResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1LeadsUpdateResponseStatus {
...
impl fmt::Display for PostV1LeadsUpdateResponseStatus {
