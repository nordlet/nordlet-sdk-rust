...
pub enum PostV1SalesInvoicesUnlockResponseType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1SalesInvoicesUnlockResponseType {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesUnlockResponseType {
...
impl fmt::Display for PostV1SalesInvoicesUnlockResponseType {
