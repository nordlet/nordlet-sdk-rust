...
pub enum PostV1AuditListRequestFilterItemOp {
    Eq,
    Ne,
    Contains,
    Gte,
...
impl Serialize for PostV1AuditListRequestFilterItemOp {
...
impl<'de> Deserialize<'de> for PostV1AuditListRequestFilterItemOp {
...
impl fmt::Display for PostV1AuditListRequestFilterItemOp {
