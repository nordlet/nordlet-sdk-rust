...
pub enum PostV1ReferenceEuVatRatesSetOverridesResponseRowsItemCategory {
    Standard,
    Reduced,
    SuperReduced,
    Parking,
...
impl Serialize for PostV1ReferenceEuVatRatesSetOverridesResponseRowsItemCategory {
...
impl<'de> Deserialize<'de> for PostV1ReferenceEuVatRatesSetOverridesResponseRowsItemCategory {
...
impl fmt::Display for PostV1ReferenceEuVatRatesSetOverridesResponseRowsItemCategory {
