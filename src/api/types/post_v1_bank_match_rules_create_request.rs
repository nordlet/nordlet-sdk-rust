...
pub struct PostV1BankMatchRulesCreateRequest {
    #[serde(default)]
    pub name: String,
...
impl PostV1BankMatchRulesCreateRequest {
    pub fn builder() -> PostV1BankMatchRulesCreateRequestBuilder {
        <PostV1BankMatchRulesCreateRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1BankMatchRulesCreateRequestBuilder {
    name: Option<String>,
...
impl PostV1BankMatchRulesCreateRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1BankMatchRulesCreateRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](PostV1BankMatchRulesCreateRequestBuilder::name)
    /// - [`pattern`](PostV1BankMatchRulesCreateRequestBuilder::pattern)
    pub fn build(self) -> Result<PostV1BankMatchRulesCreateRequest, BuildError> {
        Ok(PostV1BankMatchRulesCreateRequest {
