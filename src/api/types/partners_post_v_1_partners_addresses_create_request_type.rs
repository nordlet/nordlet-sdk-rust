...
pub enum PostV1PartnersAddressesCreateRequestType {
    Billing,
    Shipping,
    Registered,
    Other,
...
impl Serialize for PostV1PartnersAddressesCreateRequestType {
...
impl<'de> Deserialize<'de> for PostV1PartnersAddressesCreateRequestType {
...
impl fmt::Display for PostV1PartnersAddressesCreateRequestType {
