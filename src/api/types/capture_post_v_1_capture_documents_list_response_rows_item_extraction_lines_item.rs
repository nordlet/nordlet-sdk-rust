...
pub struct PostV1CaptureDocumentsListResponseRowsItemExtractionLinesItem {
    #[serde(default)]
...
impl PostV1CaptureDocumentsListResponseRowsItemExtractionLinesItem {
    pub fn builder() -> PostV1CaptureDocumentsListResponseRowsItemExtractionLinesItemBuilder {
        <PostV1CaptureDocumentsListResponseRowsItemExtractionLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1CaptureDocumentsListResponseRowsItemExtractionLinesItemBuilder {
...
impl PostV1CaptureDocumentsListResponseRowsItemExtractionLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1CaptureDocumentsListResponseRowsItemExtractionLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`description`](PostV1CaptureDocumentsListResponseRowsItemExtractionLinesItemBuilder::description)
    /// - [`quantity`](PostV1CaptureDocumentsListResponseRowsItemExtractionLinesItemBuilder::quantity)
    pub fn build(
        self,
    ) -> Result<PostV1CaptureDocumentsListResponseRowsItemExtractionLinesItem, BuildError> {
        Ok(
