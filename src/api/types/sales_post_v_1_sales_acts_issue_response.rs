...
pub struct PostV1SalesActsIssueResponse {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "partnerId")]
    #[serde(default)]
    pub partner_id: String,
    pub r#type: PostV1SalesActsIssueResponseType,
    pub status: PostV1SalesActsIssueResponseStatus,
    #[serde(default)]
    pub series: String,
    ...
    #[serde(default)]
    pub lines: Vec<PostV1SalesActsIssueResponseLinesItem>,
}

impl PostV1SalesActsIssueResponse {
    pub fn builder() -> PostV1SalesActsIssueResponseBuilder {
        <PostV1SalesActsIssueResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesActsIssueResponseBuilder {
    id: Option<String>,
    partner_id: Option<String>,
    r#type: Option<PostV1SalesActsIssueResponseType>,
    status: Option<PostV1SalesActsIssueResponseStatus>,
    ...
    lines: Option<Vec<PostV1SalesActsIssueResponseLinesItem>>,
}

impl PostV1SalesActsIssueResponseBuilder {
    ...
    pub fn r#type(mut self, value: PostV1SalesActsIssueResponseType) -> Self {
        self.r#type = Some(value);
        self
    }

    pub fn status(mut self, value: PostV1SalesActsIssueResponseStatus) -> Self {
    ...
    pub fn lines(mut self, value: Vec<PostV1SalesActsIssueResponseLinesItem>) -> Self {
        self.lines = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1SalesActsIssueResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1SalesActsIssueResponseBuilder::id)
    /// - [`partner_id`](PostV1SalesActsIssueResponseBuilder::partner_id)
    /// - [`r#type`](PostV1SalesActsIssueResponseBuilder::r#type)
    /// - [`status`](PostV1SalesActsIssueResponseBuilder::status)
    /// - [`series`](PostV1SalesActsIssueResponseBuilder::series)
    /// - [`document_date`](PostV1SalesActsIssueResponseBuilder::document_date)
    /// - [`created_at`](PostV1SalesActsIssueResponseBuilder::created_at)
    /// - [`updated_at`](PostV1SalesActsIssueResponseBuilder::updated_at)
    /// - [`lines`](PostV1SalesActsIssueResponseBuilder::lines)
    pub fn build(self) -> Result<PostV1SalesActsIssueResponse, BuildError> {
        Ok(PostV1SalesActsIssueResponse {
