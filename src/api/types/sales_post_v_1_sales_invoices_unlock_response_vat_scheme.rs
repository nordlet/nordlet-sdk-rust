...
pub enum PostV1SalesInvoicesUnlockResponseVatScheme {
    Domestic,
    IntraEuB2B,
    ReverseCharge,
    OssUnion,
...
impl Serialize for PostV1SalesInvoicesUnlockResponseVatScheme {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesUnlockResponseVatScheme {
...
impl fmt::Display for PostV1SalesInvoicesUnlockResponseVatScheme {
