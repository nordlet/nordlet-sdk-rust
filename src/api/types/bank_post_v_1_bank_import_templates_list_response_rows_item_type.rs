...
pub enum PostV1BankImportTemplatesListResponseRowsItemType {
    Stripe,
    Iso20022,
    BankConnection,
...
impl Serialize for PostV1BankImportTemplatesListResponseRowsItemType {
...
impl<'de> Deserialize<'de> for PostV1BankImportTemplatesListResponseRowsItemType {
...
impl fmt::Display for PostV1BankImportTemplatesListResponseRowsItemType {
