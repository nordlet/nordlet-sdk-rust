...
pub struct PostV1PurchasesOrdersSubmitResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1PurchasesOrdersSubmitResponseLinesItem {
    pub fn builder() -> PostV1PurchasesOrdersSubmitResponseLinesItemBuilder {
        <PostV1PurchasesOrdersSubmitResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesOrdersSubmitResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1PurchasesOrdersSubmitResponseLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesOrdersSubmitResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::id)
    /// - [`description`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::quantity)
    /// - [`received_qty`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::received_qty)
    /// - [`remaining_qty`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::remaining_qty)
    /// - [`vat_rate_percent`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1PurchasesOrdersSubmitResponseLinesItemBuilder::sort_order)
    pub fn build(self) -> Result<PostV1PurchasesOrdersSubmitResponseLinesItem, BuildError> {
        Ok(PostV1PurchasesOrdersSubmitResponseLinesItem {
