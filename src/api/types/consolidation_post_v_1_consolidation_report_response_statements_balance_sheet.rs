...
pub struct PostV1ConsolidationReportResponseStatementsBalanceSheet {
...
impl PostV1ConsolidationReportResponseStatementsBalanceSheet {
    pub fn builder() -> PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder {
        <PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder {
...
impl PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1ConsolidationReportResponseStatementsBalanceSheet`].
    /// This method will fail if any of the following fields are not set:
    /// - [`non_current_assets`](PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder::non_current_assets)
    /// - [`current_assets`](PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder::current_assets)
    /// - [`total_assets`](PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder::total_assets)
    /// - [`equity`](PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder::equity)
    /// - [`of_which_result`](PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder::of_which_result)
    /// - [`liabilities`](PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder::liabilities)
    /// - [`total_equity_and_liabilities`](PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder::total_equity_and_liabilities)
    /// - [`balanced`](PostV1ConsolidationReportResponseStatementsBalanceSheetBuilder::balanced)
    pub fn build(
        self,
    ) -> Result<PostV1ConsolidationReportResponseStatementsBalanceSheet, BuildError> {
        Ok(PostV1ConsolidationReportResponseStatementsBalanceSheet {
