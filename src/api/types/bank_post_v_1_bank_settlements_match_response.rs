...
pub struct PostV1BankSettlementsMatchResponse {
    #[serde(default)]
    pub id: String,
    ...
    pub match_status: PostV1BankSettlementsMatchResponseMatchStatus,
}

impl PostV1BankSettlementsMatchResponse {
    pub fn builder() -> PostV1BankSettlementsMatchResponseBuilder {
        <PostV1BankSettlementsMatchResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1BankSettlementsMatchResponseBuilder {
    id: Option<String>,
...
impl PostV1BankSettlementsMatchResponseBuilder {
    ...
    pub fn match_status(mut self, value: PostV1BankSettlementsMatchResponseMatchStatus) -> Self {
        self.match_status = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1BankSettlementsMatchResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1BankSettlementsMatchResponseBuilder::id)
    /// - [`external_id`](PostV1BankSettlementsMatchResponseBuilder::external_id)
    /// - [`category`](PostV1BankSettlementsMatchResponseBuilder::category)
    /// - [`date`](PostV1BankSettlementsMatchResponseBuilder::date)
    /// - [`gross`](PostV1BankSettlementsMatchResponseBuilder::gross)
    /// - [`fee`](PostV1BankSettlementsMatchResponseBuilder::fee)
    /// - [`net`](PostV1BankSettlementsMatchResponseBuilder::net)
    /// - [`match_status`](PostV1BankSettlementsMatchResponseBuilder::match_status)
    pub fn build(self) -> Result<PostV1BankSettlementsMatchResponse, BuildError> {
        Ok(PostV1BankSettlementsMatchResponse {
