...
pub struct PostV1OperationTypesListResponseRowsItem {
    #[serde(default)]
    pub id: String,
    #[serde(default)]
    pub code: String,
    ...
    pub invoice_type: Option<PostV1OperationTypesListResponseRowsItemInvoiceType>,
...
impl PostV1OperationTypesListResponseRowsItem {
    pub fn builder() -> PostV1OperationTypesListResponseRowsItemBuilder {
        <PostV1OperationTypesListResponseRowsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1OperationTypesListResponseRowsItemBuilder {
    id: Option<String>,
    code: Option<String>,
    name: Option<String>,
    invoice_type: Option<PostV1OperationTypesListResponseRowsItemInvoiceType>,
...
impl PostV1OperationTypesListResponseRowsItemBuilder {
    ...
    pub fn invoice_type(
        mut self,
        value: PostV1OperationTypesListResponseRowsItemInvoiceType,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1OperationTypesListResponseRowsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1OperationTypesListResponseRowsItemBuilder::id)
    /// - [`code`](PostV1OperationTypesListResponseRowsItemBuilder::code)
    /// - [`name`](PostV1OperationTypesListResponseRowsItemBuilder::name)
    /// - [`is_purchase`](PostV1OperationTypesListResponseRowsItemBuilder::is_purchase)
    /// - [`is_sale`](PostV1OperationTypesListResponseRowsItemBuilder::is_sale)
    /// - [`is_write_off`](PostV1OperationTypesListResponseRowsItemBuilder::is_write_off)
    /// - [`is_internal_movement`](PostV1OperationTypesListResponseRowsItemBuilder::is_internal_movement)
    /// - [`is_purchase_return`](PostV1OperationTypesListResponseRowsItemBuilder::is_purchase_return)
    /// - [`is_sales_return`](PostV1OperationTypesListResponseRowsItemBuilder::is_sales_return)
    /// - [`is_consignment`](PostV1OperationTypesListResponseRowsItemBuilder::is_consignment)
    /// - [`is_production`](PostV1OperationTypesListResponseRowsItemBuilder::is_production)
    /// - [`is_asset_in`](PostV1OperationTypesListResponseRowsItemBuilder::is_asset_in)
    /// - [`is_asset_out`](PostV1OperationTypesListResponseRowsItemBuilder::is_asset_out)
    /// - [`is_cash_register_sale`](PostV1OperationTypesListResponseRowsItemBuilder::is_cash_register_sale)
    /// - [`include_in_vat_register`](PostV1OperationTypesListResponseRowsItemBuilder::include_in_vat_register)
    /// - [`include_in_saft`](PostV1OperationTypesListResponseRowsItemBuilder::include_in_saft)
    /// - [`is_active`](PostV1OperationTypesListResponseRowsItemBuilder::is_active)
    /// - [`sort_order`](PostV1OperationTypesListResponseRowsItemBuilder::sort_order)
    /// - [`created_at`](PostV1OperationTypesListResponseRowsItemBuilder::created_at)
    /// - [`updated_at`](PostV1OperationTypesListResponseRowsItemBuilder::updated_at)
    pub fn build(self) -> Result<PostV1OperationTypesListResponseRowsItem, BuildError> {
        Ok(PostV1OperationTypesListResponseRowsItem {
