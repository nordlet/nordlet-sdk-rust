...
pub enum PostV1LedgerAccountsCreateResponseType {
    Asset,
    Liability,
    Equity,
    Income,
...
impl Serialize for PostV1LedgerAccountsCreateResponseType {
...
impl<'de> Deserialize<'de> for PostV1LedgerAccountsCreateResponseType {
...
impl fmt::Display for PostV1LedgerAccountsCreateResponseType {
