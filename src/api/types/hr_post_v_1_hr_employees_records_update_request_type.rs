...
pub enum PostV1HrEmployeesRecordsUpdateRequestType {
    Education,
    Qualification,
    Certificate,
    Training,
...
impl Serialize for PostV1HrEmployeesRecordsUpdateRequestType {
...
impl<'de> Deserialize<'de> for PostV1HrEmployeesRecordsUpdateRequestType {
...
impl fmt::Display for PostV1HrEmployeesRecordsUpdateRequestType {
