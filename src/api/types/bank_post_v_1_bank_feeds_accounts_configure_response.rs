...
pub struct PostV1BankFeedsAccountsConfigureResponse {
    #[serde(default)]
    pub id: String,
    ...
    pub sync_schedule: PostV1BankFeedsAccountsConfigureResponseSyncSchedule,
...
impl PostV1BankFeedsAccountsConfigureResponse {
    pub fn builder() -> PostV1BankFeedsAccountsConfigureResponseBuilder {
        <PostV1BankFeedsAccountsConfigureResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1BankFeedsAccountsConfigureResponseBuilder {
    id: Option<String>,
    connection_id: Option<String>,
    bank_account_id: Option<String>,
    import_template_id: Option<String>,
    sync_schedule: Option<PostV1BankFeedsAccountsConfigureResponseSyncSchedule>,
...
impl PostV1BankFeedsAccountsConfigureResponseBuilder {
    ...
    pub fn sync_schedule(
        mut self,
        value: PostV1BankFeedsAccountsConfigureResponseSyncSchedule,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1BankFeedsAccountsConfigureResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1BankFeedsAccountsConfigureResponseBuilder::id)
    /// - [`connection_id`](PostV1BankFeedsAccountsConfigureResponseBuilder::connection_id)
    /// - [`sync_schedule`](PostV1BankFeedsAccountsConfigureResponseBuilder::sync_schedule)
    /// - [`external_id`](PostV1BankFeedsAccountsConfigureResponseBuilder::external_id)
    /// - [`currency`](PostV1BankFeedsAccountsConfigureResponseBuilder::currency)
    pub fn build(self) -> Result<PostV1BankFeedsAccountsConfigureResponse, BuildError> {
        Ok(PostV1BankFeedsAccountsConfigureResponse {
