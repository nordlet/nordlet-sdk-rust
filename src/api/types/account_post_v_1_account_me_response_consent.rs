...
pub struct PostV1AccountMeResponseConsent {
...
impl PostV1AccountMeResponseConsent {
    pub fn builder() -> PostV1AccountMeResponseConsentBuilder {
        <PostV1AccountMeResponseConsentBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1AccountMeResponseConsentBuilder {
...
impl PostV1AccountMeResponseConsentBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1AccountMeResponseConsent`].
    /// This method will fail if any of the following fields are not set:
    /// - [`current_terms_version`](PostV1AccountMeResponseConsentBuilder::current_terms_version)
    /// - [`current_dpa_version`](PostV1AccountMeResponseConsentBuilder::current_dpa_version)
    /// - [`required`](PostV1AccountMeResponseConsentBuilder::required)
    pub fn build(self) -> Result<PostV1AccountMeResponseConsent, BuildError> {
        Ok(PostV1AccountMeResponseConsent {
