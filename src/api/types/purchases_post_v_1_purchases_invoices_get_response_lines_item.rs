...
pub struct PostV1PurchasesInvoicesGetResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1PurchasesInvoicesGetResponseLinesItem {
    pub fn builder() -> PostV1PurchasesInvoicesGetResponseLinesItemBuilder {
        <PostV1PurchasesInvoicesGetResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesInvoicesGetResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1PurchasesInvoicesGetResponseLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesInvoicesGetResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PurchasesInvoicesGetResponseLinesItemBuilder::id)
    /// - [`description`](PostV1PurchasesInvoicesGetResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1PurchasesInvoicesGetResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1PurchasesInvoicesGetResponseLinesItemBuilder::quantity)
    /// - [`vat_rate_percent`](PostV1PurchasesInvoicesGetResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1PurchasesInvoicesGetResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1PurchasesInvoicesGetResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1PurchasesInvoicesGetResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1PurchasesInvoicesGetResponseLinesItemBuilder::sort_order)
    pub fn build(self) -> Result<PostV1PurchasesInvoicesGetResponseLinesItem, BuildError> {
        Ok(PostV1PurchasesInvoicesGetResponseLinesItem {
