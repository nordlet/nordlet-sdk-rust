...
pub enum PostV1PurchasesOrdersApproveResponseStatus {
    Draft,
    Submitted,
    Approved,
    PartiallyReceived,
...
impl Serialize for PostV1PurchasesOrdersApproveResponseStatus {
...
impl<'de> Deserialize<'de> for PostV1PurchasesOrdersApproveResponseStatus {
...
impl fmt::Display for PostV1PurchasesOrdersApproveResponseStatus {
