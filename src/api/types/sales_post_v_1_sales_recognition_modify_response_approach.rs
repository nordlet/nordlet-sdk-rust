...
pub enum PostV1SalesRecognitionModifyResponseApproach {
    Prospective,
    CumulativeCatchUp,
...
impl Serialize for PostV1SalesRecognitionModifyResponseApproach {
...
impl<'de> Deserialize<'de> for PostV1SalesRecognitionModifyResponseApproach {
...
impl fmt::Display for PostV1SalesRecognitionModifyResponseApproach {
