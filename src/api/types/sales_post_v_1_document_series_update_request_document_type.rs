...
pub enum PostV1DocumentSeriesUpdateRequestDocumentType {
    SaleInvoice,
    SaleCreditNote,
    SaleProforma,
    SaleAdvance,
...
impl Serialize for PostV1DocumentSeriesUpdateRequestDocumentType {
...
impl<'de> Deserialize<'de> for PostV1DocumentSeriesUpdateRequestDocumentType {
...
impl fmt::Display for PostV1DocumentSeriesUpdateRequestDocumentType {
