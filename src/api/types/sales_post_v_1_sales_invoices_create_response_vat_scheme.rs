...
pub enum PostV1SalesInvoicesCreateResponseVatScheme {
    Domestic,
    IntraEuB2B,
    ReverseCharge,
    OssUnion,
...
impl Serialize for PostV1SalesInvoicesCreateResponseVatScheme {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesCreateResponseVatScheme {
...
impl fmt::Display for PostV1SalesInvoicesCreateResponseVatScheme {
