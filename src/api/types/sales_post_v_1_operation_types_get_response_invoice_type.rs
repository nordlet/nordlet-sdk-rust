...
pub enum PostV1OperationTypesGetResponseInvoiceType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1OperationTypesGetResponseInvoiceType {
...
impl<'de> Deserialize<'de> for PostV1OperationTypesGetResponseInvoiceType {
...
impl fmt::Display for PostV1OperationTypesGetResponseInvoiceType {
