...
pub struct PostV1SalesInvoicesUpdateResponse {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "partnerId")]
    #[serde(default)]
    pub partner_id: String,
    pub r#type: PostV1SalesInvoicesUpdateResponseType,
    pub status: PostV1SalesInvoicesUpdateResponseStatus,
    #[serde(rename = "paymentStatus")]
    pub payment_status: PostV1SalesInvoicesUpdateResponsePaymentStatus,
    ...
    #[serde(default)]
    pub lines: Vec<PostV1SalesInvoicesUpdateResponseLinesItem>,
    #[serde(rename = "vatEvidence")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub vat_evidence: Option<PostV1SalesInvoicesUpdateResponseVatEvidence>,
}

impl PostV1SalesInvoicesUpdateResponse {
    pub fn builder() -> PostV1SalesInvoicesUpdateResponseBuilder {
        <PostV1SalesInvoicesUpdateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesInvoicesUpdateResponseBuilder {
    id: Option<String>,
    partner_id: Option<String>,
    r#type: Option<PostV1SalesInvoicesUpdateResponseType>,
    status: Option<PostV1SalesInvoicesUpdateResponseStatus>,
    payment_status: Option<PostV1SalesInvoicesUpdateResponsePaymentStatus>,
    ...
    vat_evidence: Option<PostV1SalesInvoicesUpdateResponseVatEvidence>,
}

impl PostV1SalesInvoicesUpdateResponseBuilder {
    ...
    pub fn r#type(mut self, value: PostV1SalesInvoicesUpdateResponseType) -> Self {
        self.r#type = Some(value);
        self
    }

    pub fn status(mut self, value: PostV1SalesInvoicesUpdateResponseStatus) -> Self {
        self.status = Some(value);
        self
    }

    pub fn payment_status(mut self, value: PostV1SalesInvoicesUpdateResponsePaymentStatus) -> Self {
    ...
    pub fn lines(mut self, value: Vec<PostV1SalesInvoicesUpdateResponseLinesItem>) -> Self {
        self.lines = Some(value);
        self
    }

    pub fn vat_evidence(mut self, value: PostV1SalesInvoicesUpdateResponseVatEvidence) -> Self {
        self.vat_evidence = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1SalesInvoicesUpdateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1SalesInvoicesUpdateResponseBuilder::id)
    /// - [`partner_id`](PostV1SalesInvoicesUpdateResponseBuilder::partner_id)
    /// - [`r#type`](PostV1SalesInvoicesUpdateResponseBuilder::r#type)
    /// - [`status`](PostV1SalesInvoicesUpdateResponseBuilder::status)
    /// - [`payment_status`](PostV1SalesInvoicesUpdateResponseBuilder::payment_status)
    /// - [`currency`](PostV1SalesInvoicesUpdateResponseBuilder::currency)
    /// - [`net_total`](PostV1SalesInvoicesUpdateResponseBuilder::net_total)
    /// - [`vat_total`](PostV1SalesInvoicesUpdateResponseBuilder::vat_total)
    /// - [`gross_total`](PostV1SalesInvoicesUpdateResponseBuilder::gross_total)
    /// - [`paid_amount`](PostV1SalesInvoicesUpdateResponseBuilder::paid_amount)
    /// - [`deemed_supplier`](PostV1SalesInvoicesUpdateResponseBuilder::deemed_supplier)
    /// - [`discount_percent`](PostV1SalesInvoicesUpdateResponseBuilder::discount_percent)
    /// - [`created_at`](PostV1SalesInvoicesUpdateResponseBuilder::created_at)
    /// - [`updated_at`](PostV1SalesInvoicesUpdateResponseBuilder::updated_at)
    /// - [`lines`](PostV1SalesInvoicesUpdateResponseBuilder::lines)
    pub fn build(self) -> Result<PostV1SalesInvoicesUpdateResponse, BuildError> {
        Ok(PostV1SalesInvoicesUpdateResponse {
