...
pub enum PostV1LedgerAccountsCreateRequestType {
    Asset,
    Liability,
    Equity,
    Income,
...
impl Serialize for PostV1LedgerAccountsCreateRequestType {
...
impl<'de> Deserialize<'de> for PostV1LedgerAccountsCreateRequestType {
...
impl fmt::Display for PostV1LedgerAccountsCreateRequestType {
