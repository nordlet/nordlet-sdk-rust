...
pub struct PostV1CaptureSettingsUpdateResponse {
...
impl PostV1CaptureSettingsUpdateResponse {
    pub fn builder() -> PostV1CaptureSettingsUpdateResponseBuilder {
        <PostV1CaptureSettingsUpdateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1CaptureSettingsUpdateResponseBuilder {
...
impl PostV1CaptureSettingsUpdateResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1CaptureSettingsUpdateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`intake_enabled`](PostV1CaptureSettingsUpdateResponseBuilder::intake_enabled)
    /// - [`capture_auto_extract`](PostV1CaptureSettingsUpdateResponseBuilder::capture_auto_extract)
    /// - [`ocr_configured`](PostV1CaptureSettingsUpdateResponseBuilder::ocr_configured)
    pub fn build(self) -> Result<PostV1CaptureSettingsUpdateResponse, BuildError> {
        Ok(PostV1CaptureSettingsUpdateResponse {
            intake_enabled: self
                .intake_enabled
