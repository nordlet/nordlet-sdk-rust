...
pub struct PostV1MigrationBooksValidateRequestOpenPayablesItem {
...
impl PostV1MigrationBooksValidateRequestOpenPayablesItem {
    pub fn builder() -> PostV1MigrationBooksValidateRequestOpenPayablesItemBuilder {
        <PostV1MigrationBooksValidateRequestOpenPayablesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1MigrationBooksValidateRequestOpenPayablesItemBuilder {
...
impl PostV1MigrationBooksValidateRequestOpenPayablesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1MigrationBooksValidateRequestOpenPayablesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`partner_code`](PostV1MigrationBooksValidateRequestOpenPayablesItemBuilder::partner_code)
    /// - [`gross_total`](PostV1MigrationBooksValidateRequestOpenPayablesItemBuilder::gross_total)
    /// - [`document_number`](PostV1MigrationBooksValidateRequestOpenPayablesItemBuilder::document_number)
    /// - [`document_date`](PostV1MigrationBooksValidateRequestOpenPayablesItemBuilder::document_date)
    pub fn build(self) -> Result<PostV1MigrationBooksValidateRequestOpenPayablesItem, BuildError> {
        Ok(PostV1MigrationBooksValidateRequestOpenPayablesItem {
            partner_code: self
                .partner_code
