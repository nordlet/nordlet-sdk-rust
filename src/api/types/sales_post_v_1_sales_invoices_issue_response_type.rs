...
pub enum PostV1SalesInvoicesIssueResponseType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1SalesInvoicesIssueResponseType {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesIssueResponseType {
...
impl fmt::Display for PostV1SalesInvoicesIssueResponseType {
