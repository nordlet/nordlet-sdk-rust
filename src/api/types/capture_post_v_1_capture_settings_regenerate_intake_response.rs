...
pub struct PostV1CaptureSettingsRegenerateIntakeResponse {
...
impl PostV1CaptureSettingsRegenerateIntakeResponse {
    pub fn builder() -> PostV1CaptureSettingsRegenerateIntakeResponseBuilder {
        <PostV1CaptureSettingsRegenerateIntakeResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1CaptureSettingsRegenerateIntakeResponseBuilder {
...
impl PostV1CaptureSettingsRegenerateIntakeResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1CaptureSettingsRegenerateIntakeResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`intake_enabled`](PostV1CaptureSettingsRegenerateIntakeResponseBuilder::intake_enabled)
    /// - [`capture_auto_extract`](PostV1CaptureSettingsRegenerateIntakeResponseBuilder::capture_auto_extract)
    /// - [`ocr_configured`](PostV1CaptureSettingsRegenerateIntakeResponseBuilder::ocr_configured)
    pub fn build(self) -> Result<PostV1CaptureSettingsRegenerateIntakeResponse, BuildError> {
        Ok(PostV1CaptureSettingsRegenerateIntakeResponse {
            intake_enabled: self
                .intake_enabled
