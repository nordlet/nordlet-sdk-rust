...
pub struct PostV1ProductionWorkCentersUpdateResponse {
    #[serde(default)]
    pub id: String,
    #[serde(default)]
    pub code: String,
...
impl PostV1ProductionWorkCentersUpdateResponse {
    pub fn builder() -> PostV1ProductionWorkCentersUpdateResponseBuilder {
        <PostV1ProductionWorkCentersUpdateResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1ProductionWorkCentersUpdateResponseBuilder {
    id: Option<String>,
    code: Option<String>,
    name: Option<String>,
...
impl PostV1ProductionWorkCentersUpdateResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1ProductionWorkCentersUpdateResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1ProductionWorkCentersUpdateResponseBuilder::id)
    /// - [`code`](PostV1ProductionWorkCentersUpdateResponseBuilder::code)
    /// - [`name`](PostV1ProductionWorkCentersUpdateResponseBuilder::name)
    /// - [`cost_per_hour`](PostV1ProductionWorkCentersUpdateResponseBuilder::cost_per_hour)
    /// - [`is_active`](PostV1ProductionWorkCentersUpdateResponseBuilder::is_active)
    /// - [`created_at`](PostV1ProductionWorkCentersUpdateResponseBuilder::created_at)
    pub fn build(self) -> Result<PostV1ProductionWorkCentersUpdateResponse, BuildError> {
        Ok(PostV1ProductionWorkCentersUpdateResponse {
