...
pub enum PostV1AgreementsAgreementsUpdateResponseKind {
    Customer,
    Supplier,
    Employment,
    Bank,
...
impl Serialize for PostV1AgreementsAgreementsUpdateResponseKind {
...
impl<'de> Deserialize<'de> for PostV1AgreementsAgreementsUpdateResponseKind {
...
impl fmt::Display for PostV1AgreementsAgreementsUpdateResponseKind {
