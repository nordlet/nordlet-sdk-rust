...
pub enum PostV1BankImportTemplatesUpdateRequestType {
    Stripe,
    Iso20022,
    BankConnection,
...
impl Serialize for PostV1BankImportTemplatesUpdateRequestType {
...
impl<'de> Deserialize<'de> for PostV1BankImportTemplatesUpdateRequestType {
...
impl fmt::Display for PostV1BankImportTemplatesUpdateRequestType {
