...
pub enum PostV1SalesInvoicesUpdateRequestLinesItemRecognitionMethod {
    PointInTime,
    Ratable,
    Milestone,
    PercentComplete,
...
impl Serialize for PostV1SalesInvoicesUpdateRequestLinesItemRecognitionMethod {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesUpdateRequestLinesItemRecognitionMethod {
...
impl fmt::Display for PostV1SalesInvoicesUpdateRequestLinesItemRecognitionMethod {
