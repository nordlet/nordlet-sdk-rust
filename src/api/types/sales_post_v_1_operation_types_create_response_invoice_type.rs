...
pub enum PostV1OperationTypesCreateResponseInvoiceType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1OperationTypesCreateResponseInvoiceType {
...
impl<'de> Deserialize<'de> for PostV1OperationTypesCreateResponseInvoiceType {
...
impl fmt::Display for PostV1OperationTypesCreateResponseInvoiceType {
