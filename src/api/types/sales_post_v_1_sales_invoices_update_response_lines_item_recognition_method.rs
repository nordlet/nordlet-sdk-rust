...
pub enum PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod {
    PointInTime,
    Ratable,
    Milestone,
    PercentComplete,
...
impl Serialize for PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod {
...
impl fmt::Display for PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod {
