...
pub enum PostV1PartnersVatReviewsResolveResponseResolution {
    ConfirmedValid,
    ConfirmedInvalid,
    Dismissed,
    Revalidated,
...
impl Serialize for PostV1PartnersVatReviewsResolveResponseResolution {
...
impl<'de> Deserialize<'de> for PostV1PartnersVatReviewsResolveResponseResolution {
...
impl fmt::Display for PostV1PartnersVatReviewsResolveResponseResolution {
