...
pub struct PostV1CaptureDocumentsExtractResponseExtractionLinesItem {
    #[serde(default)]
...
impl PostV1CaptureDocumentsExtractResponseExtractionLinesItem {
    pub fn builder() -> PostV1CaptureDocumentsExtractResponseExtractionLinesItemBuilder {
        <PostV1CaptureDocumentsExtractResponseExtractionLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1CaptureDocumentsExtractResponseExtractionLinesItemBuilder {
...
impl PostV1CaptureDocumentsExtractResponseExtractionLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1CaptureDocumentsExtractResponseExtractionLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`description`](PostV1CaptureDocumentsExtractResponseExtractionLinesItemBuilder::description)
    /// - [`quantity`](PostV1CaptureDocumentsExtractResponseExtractionLinesItemBuilder::quantity)
    pub fn build(
        self,
    ) -> Result<PostV1CaptureDocumentsExtractResponseExtractionLinesItem, BuildError> {
        Ok(PostV1CaptureDocumentsExtractResponseExtractionLinesItem {
            description: self
                .description
