...
pub enum PostV1FleetVehiclesCreateRequestFuelType {
    Petrol,
    Diesel,
    Electric,
    Hybrid,
...
impl Serialize for PostV1FleetVehiclesCreateRequestFuelType {
...
impl<'de> Deserialize<'de> for PostV1FleetVehiclesCreateRequestFuelType {
...
impl fmt::Display for PostV1FleetVehiclesCreateRequestFuelType {
