...
pub enum PostV1SalesInvoicesGetResponseVatScheme {
    Domestic,
    IntraEuB2B,
    ReverseCharge,
    OssUnion,
...
impl Serialize for PostV1SalesInvoicesGetResponseVatScheme {
...
impl<'de> Deserialize<'de> for PostV1SalesInvoicesGetResponseVatScheme {
...
impl fmt::Display for PostV1SalesInvoicesGetResponseVatScheme {
