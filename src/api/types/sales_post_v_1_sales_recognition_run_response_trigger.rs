...
pub enum PostV1SalesRecognitionRunResponseTrigger {
    Manual,
    ScheduleDue,
    PeriodClose,
    DeliveryAct,
...
impl Serialize for PostV1SalesRecognitionRunResponseTrigger {
...
impl<'de> Deserialize<'de> for PostV1SalesRecognitionRunResponseTrigger {
...
impl fmt::Display for PostV1SalesRecognitionRunResponseTrigger {
