...
pub struct PostV1SalesInvoicesIssueResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
    ...
    pub recognition_method: PostV1SalesInvoicesIssueResponseLinesItemRecognitionMethod,
    ...
    pub recognition_milestones:
        Option<Vec<PostV1SalesInvoicesIssueResponseLinesItemRecognitionMilestonesItem>>,
...
impl PostV1SalesInvoicesIssueResponseLinesItem {
    pub fn builder() -> PostV1SalesInvoicesIssueResponseLinesItemBuilder {
        <PostV1SalesInvoicesIssueResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesInvoicesIssueResponseLinesItemBuilder {
    id: Option<String>,
    ...
    recognition_method: Option<PostV1SalesInvoicesIssueResponseLinesItemRecognitionMethod>,
...
impl PostV1SalesInvoicesIssueResponseLinesItemBuilder {
    ...
    pub fn recognition_method(
        mut self,
        value: PostV1SalesInvoicesIssueResponseLinesItemRecognitionMethod,
    ) -> Self {
    ...
    pub fn recognition_milestones(
        mut self,
        value: Vec<PostV1SalesInvoicesIssueResponseLinesItemRecognitionMilestonesItem>,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostV1SalesInvoicesIssueResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1SalesInvoicesIssueResponseLinesItemBuilder::id)
    /// - [`description`](PostV1SalesInvoicesIssueResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1SalesInvoicesIssueResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1SalesInvoicesIssueResponseLinesItemBuilder::quantity)
    /// - [`vat_rate_percent`](PostV1SalesInvoicesIssueResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1SalesInvoicesIssueResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1SalesInvoicesIssueResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1SalesInvoicesIssueResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1SalesInvoicesIssueResponseLinesItemBuilder::sort_order)
    /// - [`recognition_method`](PostV1SalesInvoicesIssueResponseLinesItemBuilder::recognition_method)
    pub fn build(self) -> Result<PostV1SalesInvoicesIssueResponseLinesItem, BuildError> {
        Ok(PostV1SalesInvoicesIssueResponseLinesItem {
