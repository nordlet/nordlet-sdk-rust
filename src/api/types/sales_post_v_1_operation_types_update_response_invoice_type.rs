...
pub enum PostV1OperationTypesUpdateResponseInvoiceType {
    Invoice,
    CreditNote,
    Proforma,
    Advance,
...
impl Serialize for PostV1OperationTypesUpdateResponseInvoiceType {
...
impl<'de> Deserialize<'de> for PostV1OperationTypesUpdateResponseInvoiceType {
...
impl fmt::Display for PostV1OperationTypesUpdateResponseInvoiceType {
