...
pub struct PostV1PurchasesInvoicesUpdateResponseLinesItem {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "itemId")]
...
impl PostV1PurchasesInvoicesUpdateResponseLinesItem {
    pub fn builder() -> PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder {
        <PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder {
    id: Option<String>,
...
impl PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1PurchasesInvoicesUpdateResponseLinesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder::id)
    /// - [`description`](PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder::description)
    /// - [`unit`](PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder::unit)
    /// - [`quantity`](PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder::quantity)
    /// - [`vat_rate_percent`](PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder::vat_rate_percent)
    /// - [`line_net`](PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder::line_net)
    /// - [`line_vat`](PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder::line_vat)
    /// - [`line_gross`](PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder::line_gross)
    /// - [`sort_order`](PostV1PurchasesInvoicesUpdateResponseLinesItemBuilder::sort_order)
    pub fn build(self) -> Result<PostV1PurchasesInvoicesUpdateResponseLinesItem, BuildError> {
        Ok(PostV1PurchasesInvoicesUpdateResponseLinesItem {
