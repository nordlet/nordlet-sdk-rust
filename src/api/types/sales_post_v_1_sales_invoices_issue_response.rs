...
pub struct PostV1SalesInvoicesIssueResponse {
    #[serde(default)]
    pub id: String,
    #[serde(rename = "partnerId")]
    #[serde(default)]
    pub partner_id: String,
    pub r#type: PostV1SalesInvoicesIssueResponseType,
    pub status: PostV1SalesInvoicesIssueResponseStatus,
    #[serde(rename = "paymentStatus")]
    pub payment_status: PostV1SalesInvoicesIssueResponsePaymentStatus,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub vat_scheme: Option<PostV1SalesInvoicesIssueResponseVatScheme>,
    ...
    #[serde(default)]
    pub lines: Vec<PostV1SalesInvoicesIssueResponseLinesItem>,
    #[serde(rename = "vatEvidence")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub vat_evidence: Option<PostV1SalesInvoicesIssueResponseVatEvidence>,
}

impl PostV1SalesInvoicesIssueResponse {
    pub fn builder() -> PostV1SalesInvoicesIssueResponseBuilder {
        <PostV1SalesInvoicesIssueResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1SalesInvoicesIssueResponseBuilder {
    id: Option<String>,
    partner_id: Option<String>,
    r#type: Option<PostV1SalesInvoicesIssueResponseType>,
    status: Option<PostV1SalesInvoicesIssueResponseStatus>,
    payment_status: Option<PostV1SalesInvoicesIssueResponsePaymentStatus>,
    ...
    vat_scheme: Option<PostV1SalesInvoicesIssueResponseVatScheme>,
    ...
    vat_evidence: Option<PostV1SalesInvoicesIssueResponseVatEvidence>,
}

impl PostV1SalesInvoicesIssueResponseBuilder {
    ...
    pub fn r#type(mut self, value: PostV1SalesInvoicesIssueResponseType) -> Self {
        self.r#type = Some(value);
        self
    }

    pub fn status(mut self, value: PostV1SalesInvoicesIssueResponseStatus) -> Self {
        self.status = Some(value);
        self
    }

    pub fn payment_status(mut self, value: PostV1SalesInvoicesIssueResponsePaymentStatus) -> Self {
    ...
    pub fn vat_scheme(mut self, value: PostV1SalesInvoicesIssueResponseVatScheme) -> Self {
    ...
    pub fn lines(mut self, value: Vec<PostV1SalesInvoicesIssueResponseLinesItem>) -> Self {
        self.lines = Some(value);
        self
    }

    pub fn vat_evidence(mut self, value: PostV1SalesInvoicesIssueResponseVatEvidence) -> Self {
        self.vat_evidence = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostV1SalesInvoicesIssueResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1SalesInvoicesIssueResponseBuilder::id)
    /// - [`partner_id`](PostV1SalesInvoicesIssueResponseBuilder::partner_id)
    /// - [`r#type`](PostV1SalesInvoicesIssueResponseBuilder::r#type)
    /// - [`status`](PostV1SalesInvoicesIssueResponseBuilder::status)
    /// - [`payment_status`](PostV1SalesInvoicesIssueResponseBuilder::payment_status)
    /// - [`currency`](PostV1SalesInvoicesIssueResponseBuilder::currency)
    /// - [`net_total`](PostV1SalesInvoicesIssueResponseBuilder::net_total)
    /// - [`vat_total`](PostV1SalesInvoicesIssueResponseBuilder::vat_total)
    ...
    pub fn build(self) -> Result<PostV1SalesInvoicesIssueResponse, BuildError> {
        Ok(PostV1SalesInvoicesIssueResponse {
