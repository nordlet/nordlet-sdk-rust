...
pub struct PostV1ProductionOrdersCreateResponseOperationsItem {
    #[serde(default)]
    pub id: String,
...
impl PostV1ProductionOrdersCreateResponseOperationsItem {
    pub fn builder() -> PostV1ProductionOrdersCreateResponseOperationsItemBuilder {
        <PostV1ProductionOrdersCreateResponseOperationsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostV1ProductionOrdersCreateResponseOperationsItemBuilder {
    id: Option<String>,
...
impl PostV1ProductionOrdersCreateResponseOperationsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PostV1ProductionOrdersCreateResponseOperationsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PostV1ProductionOrdersCreateResponseOperationsItemBuilder::id)
    /// - [`work_center_id`](PostV1ProductionOrdersCreateResponseOperationsItemBuilder::work_center_id)
    /// - [`sequence`](PostV1ProductionOrdersCreateResponseOperationsItemBuilder::sequence)
    /// - [`name`](PostV1ProductionOrdersCreateResponseOperationsItemBuilder::name)
    /// - [`planned_minutes`](PostV1ProductionOrdersCreateResponseOperationsItemBuilder::planned_minutes)
    /// - [`cost_per_hour`](PostV1ProductionOrdersCreateResponseOperationsItemBuilder::cost_per_hour)
    pub fn build(self) -> Result<PostV1ProductionOrdersCreateResponseOperationsItem, BuildError> {
        Ok(PostV1ProductionOrdersCreateResponseOperationsItem {
